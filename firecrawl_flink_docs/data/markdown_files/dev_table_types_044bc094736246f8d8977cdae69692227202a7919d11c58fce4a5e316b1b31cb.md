# Data Types  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#data-types)

Flink SQL has a rich set of native data types available to users.

## Data Type  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#data-type)

A _data type_ describes the logical type of a value in the table ecosystem.
It can be used to declare input and/or output types of operations.

Flink’s data types are similar to the SQL standard’s _data type_ terminology but also contain information
...
A list of all pre-defined data types can be found [below](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/#list-of-data-types).

### Data Types in the Table API  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#data-types-in-the-table-api)
...
#### Physical Hints  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#physical-hints)
...
## List of Data Types  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#list-of-data-types)
...
### Character Strings  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#character-strings)

#### `CHAR` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#char)
...
#### `VARCHAR` / `STRING` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#varchar--string)
...
### Binary Strings  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#binary-strings)

#### `BINARY` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#binary)
...
#### `VARBINARY` / `BYTES` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#varbinary--bytes)
...
### Exact Numerics  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#exact-numerics)

#### `DECIMAL` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#decimal)
...
number ( _precision_) and `s` is the number of digits to the right of the decimal point
in a number ( _scale_). `p` must have a value between `1` and `38` (both inclusive). `s`
...
#### `TINYINT` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#tinyint)
...
#### `SMALLINT` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#smallint)
...
#### `INT` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#int)
...
#### `BIGINT` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#bigint)
...
### Approximate Numerics  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#approximate-numerics)

#### `FLOAT` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#float)
...
#### `DOUBLE` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#double)
...
### Date and Time  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#date-and-time)

#### `DATE` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#date)
...
#### `TIME` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#time)

Data type of a time _without_ time zone consisting of `hour:minute:second[.fractional]` with
...
the semantics are closer to `java.time.LocalTime`. A time _with_ time zone is not provided.

Python

Compared to the SQL standard, leap seconds (`23:59:60` and `23:59:61`) are not supported.
A time _with_ time zone is not provided.
...
seconds ( _precision_). `p` must have a value between `0` and `9` (both inclusive). If no
precision is specified, `p` is equal to `0`.

#### `TIMESTAMP` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#timestamp)

Data type of a timestamp _without_ time zone consisting of `year-month-day hour:minute:second[.fractional]`
...
seconds ( _precision_). `p` must have a value between `0` and `9` (both inclusive). If no precision
is specified, `p` is equal to `6`.

`TIMESTAMP(p) WITHOUT TIME ZONE` is a synonym for this type.

#### `TIMESTAMP WITH TIME ZONE` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#timestamp-with-time-zone)

Data type of a timestamp _with_ time zone consisting of `year-month-day hour:minute:second[.fractional] zone`
...
fractional seconds ( _precision_). `p` must have a value between `0` and `9` (both inclusive). If no
precision is specified, `p` is equal to `6`.

Python

#### `TIMESTAMP_LTZ` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#timestamp_ltz)

Data type of a timestamp _with local_ time zone consisting of `year-month-day hour:minute:second[.fractional] zone`
with up to nanosecond precision and values ranging from `0000-01-01 00:00:00.000000000 +14:59` to
`9999-12-31 23:59:59.999999999 -14:59`.
...
of digits of fractional seconds ( _precision_). `p` must have a value between `0` and `9`
(both inclusive). If no precision is specified, `p` is equal to `6`.

`TIMESTAMP(p) WITH LOCAL TIME ZONE` is a synonym for this type.

#### `INTERVAL YEAR TO MONTH` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#interval-year-to-month)
...
( _year precision_). `p` must have a value between `1` and `4` (both inclusive). If no year precision
is specified, `p` is equal to `2`.

#### `INTERVAL DAY TO SECOND` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#interval-day-to-second)
...
( _day precision_) and `p2` is the number of digits of fractional seconds ( _fractional precision_).
...
### Constructured Data Types  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#constructured-data-types)

#### `ARRAY` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#array)
...
#### `MAP` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#map)
...
#### `MULTISET` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#multiset)
...
#### `ROW` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#row)
...
### User-Defined Data Types  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#user-defined-data-types)

#### `STRUCTURED` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#structured)
...
using the `@DataTypeHint` [annotations](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/#data-type-annotations).
...
| Java Type | Input | Output | Remarks |
| --- | --- | --- | --- |
| _class_ | X | X | Originating class or subclasses (for input) or <br>superclasses (for output). _Default_ |
...
### Other Data Types  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#other-data-types)

#### `BOOLEAN` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#boolean)
...
#### `DESCRIPTOR` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#descriptor)
...
#### `VARIANT` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#variant)
...
#### `RAW` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#raw)
...
#### `NULL` [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#null)
...
## Casting  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#casting)
...
### Legacy casting  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#legacy-casting)
...
## Data Type Extraction  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/\#data-type-extraction)
...
If you intend to implement classes in Scala, _it is recommended to use boxed types_ (e.g. `java.lang.Integer`)
