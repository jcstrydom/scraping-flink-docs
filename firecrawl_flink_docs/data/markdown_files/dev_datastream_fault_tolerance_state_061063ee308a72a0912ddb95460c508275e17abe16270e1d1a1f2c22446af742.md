> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/datastream/fault-tolerance/state/).

# Working with State  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#working-with-state)
...
Processing](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/concepts/stateful-stream-processing/)
to learn about the concepts behind stateful stream processing.

## Keyed DataStream  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#keyed-datastream)
...
#### Tuple Keys and Expression Keys  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#tuple-keys-and-expression-keys)
...
## Using Keyed State  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#using-keyed-state)
...
State is accessed using the `RuntimeContext`, so it is only possible in _rich functions_.
Please see [here](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/user_defined_functions/#rich-functions) for
...
A _time-to-live_ (TTL) can be assigned to the keyed state of any type. If a TTL is configured and a
...
#### Cleanup of Expired State  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#cleanup-of-expired-state)
...
##### Cleanup in full snapshot  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#cleanup-in-full-snapshot) [Anchor link for: cleanup in full snapshot](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#cleanup-in-full-snapshot)
...
##### Incremental cleanup  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#incremental-cleanup) [Anchor link for: incremental cleanup](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#incremental-cleanup)
...
##### Cleanup during RocksDB compaction  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#cleanup-during-rocksdb-compaction) [Anchor link for: cleanup during rocksdb compaction](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#cleanup-during-rocksdb-compaction)
...
### State in the Scala DataStream API  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#state-in-the-scala-datastream-api)
...
## Operator State  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#operator-state)

_Operator State_ (or _non-keyed state_) is state that is bound to one
parallel operator instance. The [Kafka Connector](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/datastream/kafka/) is a good motivating example for the use of
...
## Broadcast State  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#broadcast-state)

_Broadcast State_ is a special type of _Operator State_. It was introduced to
...
_broadcasted_ stream and a _non-broadcasted_ one, and
3. such an operator can have _multiple broadcast states_ with different names.

## Using Operator State  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#using-operator-state)

To use operator state, a stateful function can implement the `CheckpointedFunction`
interface.

#### CheckpointedFunction  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#checkpointedfunction)
...
is expected to be a `List` of _serializable_ objects, independent from each other,
...
If the method name does not contain the redistribution pattern, _e.g._`getListState(descriptor)`,
...
recovering after a failure. If this is `true`, _i.e._ we are recovering, the restore logic is applied.
...
### Stateful Source Functions  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/\#stateful-source-functions)
