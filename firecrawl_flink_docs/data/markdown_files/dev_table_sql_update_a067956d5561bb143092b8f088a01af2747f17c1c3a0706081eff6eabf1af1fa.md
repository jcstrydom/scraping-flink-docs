# UPDATE Statements  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/update/\#update-statements)
...
[SupportsRowLevelUpdate](https://github.com/apache/flink/blob/release-2.2/flink-table/flink-table-common/src/main/java/org/apache/flink/table/connector/sink/abilities/SupportsRowLevelUpdate.java)
...
## Run a UPDATE statement  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/update/\#run-a-update-statement)
...
UPDATE statements can be executed in [SQL CLI](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sqlclient/).
...
## UPDATE ROWS  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/update/\#update-rows)
