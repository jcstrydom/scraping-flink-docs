# Concepts & Common API  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#concepts--common-api)
...
## Structure of Table API and SQL Programs  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#structure-of-table-api-and-sql-programs)
...
> Have a look at the [DataStream API Integration](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/data_stream_api/) page
> to learn how DataStreams can be converted into Tables and vice versa.

## Create a TableEnvironment  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#create-a-tableenvironment)
...
## Create Tables in the Catalog  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#create-tables-in-the-catalog)
...
specified, the current default value will be used (see examples in the [Table identifier expanding](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/#table-identifier-expanding) section).
...
### Temporary vs Permanent tables.  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#temporary-vs-permanent-tables)
...
Permanent tables require a [catalog](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/catalogs/) (such as Hive Metastore)
...
#### Shadowing  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#shadowing)
...
### Create a Table  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#create-a-table)

#### Virtual Tables  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#virtual-tables)
...
registered `Table` will _not_ be shared.

#### Connector Tables  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#connector-tables)

It is also possible to create a `TABLE` as known from relational databases from a [connector](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/connectors/table/overview/) declaration.
...
### Expanding Table identifiers  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#expanding-table-identifiers)
...
## Query a Table  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#query-a-table)

### Table API  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#table-api)
...
The [Table API](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/tableapi/) document describes all Table API operations that are supported on streaming and batch tables.
...
### SQL  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#sql)
...
The [SQL](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/overview/) document describes Flink’s SQL support for streaming and batch tables.
...
### Mixing Table API and SQL  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#mixing-table-api-and-sql)
...
- A SQL query can be defined on the result of a Table API query by [registering the resulting Table](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/#register-a-table) in the `TableEnvironment` and referencing it in the `FROM` clause of the SQL query.

## Emit a Table  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#emit-a-table)
...
Please see the documentation about [Table Sources & Sinks](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sourcessinks/) for details about available sinks and instructions for how to implement a custom `DynamicTableSink`.
...
## Translate and Execute a Query  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#translate-and-execute-a-query)

Table API and SQL queries are translated into [DataStream](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/) programs whether their input is streaming or batch.
...
- A `Table` is translated when it is converted into a `DataStream` (see [Integration with DataStream](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/#integration-with-datastream)). Once translated, it’s a regular DataStream program and is executed when `StreamExecutionEnvironment.execute()` is called.

## Query Optimization  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#query-optimization)
...
## Explaining a Table  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/\#explaining-a-table)
...
`TableEnvironment.explainSql()` and `TableEnvironment.executeSql()` support execute a `EXPLAIN` statement to get the plans, Please refer to [EXPLAIN](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/explain/) page.
