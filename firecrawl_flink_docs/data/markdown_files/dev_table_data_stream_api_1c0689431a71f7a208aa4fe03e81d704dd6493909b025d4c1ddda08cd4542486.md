# DataStream API Integration  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#datastream-api-integration)
...
## Converting between DataStream and Table  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#converting-between-datastream-and-table)
...
The complete semantics of `fromDataStream` and `toDataStream` can be found in the [dedicated section below](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/#handling-of-insert-only-streams).
...
The complete semantics of `fromChangelogStream` and `toChangelogStream` can be found in the [dedicated section below](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/#handling-of-insert-only-streams).
...
updates](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/concepts/dynamic_tables/) for each incoming record. However, in
cases where the input streams are finite (i.e. _bounded_), a result can be computed more efficiently
...
the actual joining (i.e. _sort-merge join algorithm_), or build a hash table from one input before
consuming the other (i.e. build/probe phase of the _hash join algorithm_).
...
also the [dedicated batch mode section below](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/#batch-runtime-mode) for more insights.

### Dependencies and Imports  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#dependencies-and-imports)
...
Please refer to the [configuration](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/configuration/overview/) section for more information.

### Configuration  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#configuration)
...
### Execution Behavior  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#execution-behavior)
...
## Batch Runtime Mode  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#batch-runtime-mode)

The _batch runtime mode_ is a specialized execution mode for _bounded_ Flink programs.

Generally speaking, _boundedness_ is a property of a data source that tells us whether all the records
...
For more information on the different execution modes, see also the corresponding [DataStream API section](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/execution_mode/).
...
- Operators need a sufficient amount of [off-heap memory](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/memory/mem_setup_tm/#managed-memory)
...
- Exchanges between tasks might be blocking according to the [`execution.batch-shuffle-mode`](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/#execution-batch-shuffle-mode).
...
> Since batch processing can be considered as _a special case of stream processing_, we recommend implementing
...
The following example shows how to play around with batch mode using the [DataGen table source](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/connectors/table/datagen/).
...
### Changelog Unification  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#changelog-unification)
...
## Handling of (Insert-Only) Streams  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#handling-of-insert-only-streams)
...
writing to a virtual table connector that has been defined using a [`CREATE TABLE` DDL](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/#create-table)
in SQL.
...
The virtual DataStream table source implements [`SupportsSourceWatermark`](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sourcessinks/#source-abilities)
...
### Examples for `fromDataStream` [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#examples-for-fromdatastream)
...
[Data Types & Serialization](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/fault-tolerance/serialization/types_serialization/) page of
...
### Examples for `createTemporaryView` [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#examples-for-createtemporaryview)
...
### Examples for `toDataStream` [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#examples-for-todatastream)
...
## Handling of Changelog Streams  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#handling-of-changelog-streams)

Internally, Flink’s table runtime is a changelog processor. The concepts page describes how
[dynamic tables and streams relate](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/concepts/dynamic_tables/)
to each other.
...
the [previous section](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/#handling-of-insert-only-streams) before continuing here.

This virtual connector also supports reading and writing the `rowtime` metadata of the stream record.

The virtual table source implements [`SupportsSourceWatermark`](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sourcessinks/#source-abilities).

### Examples for `fromChangelogStream` [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#examples-for-fromchangelogstream)
...
### Examples for `toChangelogStream` [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#examples-for-tochangelogstream)
...
[Table API’s Data Types page](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/).
...
## Adding Table API Pipelines to DataStream API  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#adding-table-api-pipelines-to-datastream-api)

A single Flink job can consist of multiple disconnected pipelines that run next to each other.

Source-to-sink pipelines defined in Table API can be attached _as a whole_ to the `StreamExecutionEnvironment`
...
## Implicit Conversions in Scala  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#implicit-conversions-in-scala)

Users of the Scala API can use all the conversion methods above in a more fluent way by leveraging
Scala’s _implicit_ feature.
...
## Mapping between TypeInformation and DataType  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#mapping-between-typeinformation-and-datatype)
...
### TypeInformation to DataType  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#typeinformation-to-datatype)
...
- See
[TypeInfoDataTypeConverter](https://github.com/apache/flink/blob/release-2.2/flink-table/flink-table-common/src/main/java/org/apache/flink/table/types/utils/TypeInfoDataTypeConverter.java)
...
### DataType to TypeInformation  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#datatype-to-typeinformation)
...
## Legacy Conversion  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#legacy-conversion)
...
### Convert a DataStream into a Table  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#convert-a-datastream-into-a-table)
...
### Convert a Table into a DataStream  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#convert-a-table-into-a-datastream)
...
#### Convert a Table into a DataStream  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#convert-a-table-into-a-datastream-1)
...
**Note:** A detailed discussion about dynamic tables and their properties is given in the [Dynamic Tables](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/concepts/dynamic_tables/) document.
...
### Mapping of Data Types to Table Schema  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#mapping-of-data-types-to-table-schema)
...
#### Atomic Types  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#atomic-types)
...
#### Tuples (Scala, Java, Python) and Case Classes (Scala only)  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#tuples-scala-java-python-and-case-classes-scala-only)
...
#### POJO (Java and Scala)  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#pojo-java-and-scala)

Flink supports POJOs as composite types. The rules for what determines a POJO are documented [here](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/fault-tolerance/serialization/types_serialization/#pojos).
...
#### Row  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/data_stream_api/\#row)
