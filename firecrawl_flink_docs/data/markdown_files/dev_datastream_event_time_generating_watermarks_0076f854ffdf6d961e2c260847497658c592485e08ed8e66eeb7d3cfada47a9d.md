> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/datastream/event-time/generating_watermarks/).

# Generating Watermarks  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/\#generating-watermarks)

In this section you will learn about the APIs that Flink provides for working
with **event time** timestamps and watermarks. For an introduction to _event_
_time_, _processing time_, and _ingestion time_, please refer to the
[introduction to event time](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/concepts/time/).

## Introduction to Watermark Strategies  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/\#introduction-to-watermark-strategies)

In order to work with _event time_, Flink needs to know the events
_timestamps_, meaning each element in the stream needs to have its event
timestamp _assigned_. This is usually done by accessing/extracting the
...
WatermarkGenerators](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/#writing-watermarkgenerators).

> **Attention**: Both timestamps and watermarks
> are specified as milliseconds since the Java epoch of 1970-01-01T00:00:00Z.

## Using Watermark Strategies  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/\#using-watermark-strategies)
...
Connector](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/#watermark-strategies-and-the-kafka-connector) for how this works on
...
on which to base a watermark. We call this an _idle input_ or an _idle source_.
...
## Watermark alignment  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/\#watermark-alignment)
...
> **Note:** You can enable watermark alignment only for [FLIP-27](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/sources/)
> sources. It does not work for legacy or if applied after the source via
> [DataStream#assignTimestampsAndWatermarks](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/#using-watermark-strategies).
...
> can be aligned in the same task. More detail on the pause and resume interfaces can found in the [Source API](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/sources/#split-level-watermark-alignment).
>
...
There are two different styles of watermark generation: _periodic_ and
_punctuated_.
...
_marker events_ or _punctuations_ that carry watermark information in the
...
### Writing a Periodic WatermarkGenerator  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/\#writing-a-periodic-watermarkgenerator)
...
The interval (every _n_ milliseconds) in which the watermark will be generated
...
about using that [here](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/built_in/).
...
### Writing a Punctuated WatermarkGenerator  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/\#writing-a-punctuated-watermarkgenerator)
...
## Watermark Strategies and the Kafka Connector  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/\#watermark-strategies-and-the-kafka-connector)

When using [Apache Kafka](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/datastream/kafka/) as a data source, each Kafka
...
generator](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/built_in/#monotonously-increasing-timestamps)
...
![Generating Watermarks with awareness for Kafka-partitions](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/parallel_kafka_watermarks.svg)

## How Operators Process Watermarks  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/\#how-operators-process-watermarks)
...
## The Deprecated AssignerWithPeriodicWatermarks and AssignerWithPunctuatedWatermarks  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/\#the-deprecated-assignerwithperiodicwatermarks-and-assignerwithpunctuatedwatermarks)
