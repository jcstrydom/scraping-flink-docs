# ANALYZE Statements  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/analyze/\#analyze-statements)
...
## Run an ANALYZE TABLE statement  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/analyze/\#run-an-analyze-table-statement)
...
`ANALYZE TABLE` statements can be executed in [SQL CLI](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sqlclient/).
...
## Syntax  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/analyze/\#syntax)
