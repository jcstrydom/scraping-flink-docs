> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/queries/overview/).

# Queries  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/overview/\#queries)
...
A `Table` can be used in [subsequent SQL and Table API queries](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/common/#mixing-table-api-and-sql), be [converted into a DataStream](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/common/#integration-with-datastream), or [written to a TableSink](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/common/#emit-a-table).
SQL and Table API queries can be seamlessly mixed and are holistically optimized and translated into a single program.

In order to access a table in a SQL query, it must be [registered in the TableEnvironment](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/common/#register-tables-in-the-catalog).
A table can be registered from a [TableSource](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/common/#register-a-tablesource), [Table](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/common/#register-a-table), [CREATE TABLE statement](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/overview/#create-table), [DataStream](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/common/#register-a-datastream).
Alternatively, users can also [register catalogs in a TableEnvironment](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/catalogs/) to specify the location of the data sources.
...
## Specifying a Query  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/overview/\#specifying-a-query)
...
## Execute a Query  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/overview/\#execute-a-query)
...
`TableResult.collect()` and `TableResult.print()` have slightly different behaviors under different checkpointing settings (to enable checkpointing for a streaming job, see [checkpointing config](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/config/#checkpointing)).
...
## Syntax  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/overview/\#syntax)

Flink parses SQL using [Apache Calcite](https://calcite.apache.org/docs/reference.html), which supports standard ANSI SQL.

The following BNF-grammar describes the superset of supported SQL features in batch and streaming queries. The [Operations](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/overview/#operations) section shows examples for the supported features and indicates which features are only supported for batch or streaming queries.
...
## Operations  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/overview/\#operations)
