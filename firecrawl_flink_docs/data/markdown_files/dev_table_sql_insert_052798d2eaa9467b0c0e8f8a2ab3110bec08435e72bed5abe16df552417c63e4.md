# INSERT Statement  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/insert/\#insert-statement)

INSERT statements are used to add rows to a table.

## Run an INSERT statement  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/insert/\#run-an-insert-statement)
...
Single INSERT statement can be executed in [SQL CLI](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sqlclient/).
...
## Insert from select queries  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/insert/\#insert-from-select-queries)

Query Results can be inserted into tables by using the insert clause.

### Syntax  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/insert/\#syntax)
...
[DynamicTableSink$Context.getTargetColumns()](https://github.com/apache/flink/blob/release-2.2/flink-table/flink-table-common/src/main/java/org/apache/flink/table/connector/sink/DynamicTableSink.java)

and decide how to process the partial updates.

### Examples  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/insert/\#examples)
...
## Insert values into tables  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/insert/\#insert-values-into-tables)

The INSERT…VALUES statement can be used to insert data into tables directly from SQL.

### Syntax  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/insert/\#syntax-1)
...
### Examples  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/insert/\#examples-1)
...
## Insert into multiple tables  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/insert/\#insert-into-multiple-tables)

The `STATEMENT SET` can be used to insert data into multiple tables in a statement.

### Syntax  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/insert/\#syntax-2)
...
### Examples  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/insert/\#examples-2)
