> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/python/dependency_management/).

# Dependency Management  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/dependency_management/\#dependency-management)
...
## JAR Dependencies  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/dependency_management/\#jar-dependencies)
...
or through the [command line arguments](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/cli/#submitting-pyflink-jobs)`--jarfile` when submitting the job.
...
## Python Dependencies  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/dependency_management/\#python-dependencies)

### Python libraries  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/dependency_management/\#python-libraries)
...
[`python.files`](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/python_config/#python-files)
or via [command line arguments](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/cli/#submitting-pyflink-jobs)`-pyfs` or `--pyFiles`
...
### requirements.txt  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/dependency_management/\#requirementstxt)
...
[`python.requirements`](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/python_config/#python-requirements)
or via [command line arguments](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/cli/#submitting-pyflink-jobs)`-pyreq` or `--pyRequirements` when submitting the job.
...
### Archives  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/dependency_management/\#archives)
...
[`python.archives`](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/python_config/#python-archives)
or via [command line arguments](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/cli/#submitting-pyflink-jobs)`-pyarch` or `--pyArchives` when submitting the job.
...
### Python interpreter  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/dependency_management/\#python-interpreter)
...
[`python.executable`](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/python_config/#python-executable)
or via [command line arguments](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/cli/#submitting-pyflink-jobs)`-pyexec` or `--pyExecutable` when submitting the job.
...
### Python interpreter of client  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/dependency_management/\#python-interpreter-of-client)
...
[`python.client.executable`](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/python_config/#python-client-executable),
[command line arguments](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/cli/#submitting-pyflink-jobs)`-pyclientexec` or `--pyClientExecutable`,
environment variable [PYFLINK\_CLIENT\_EXECUTABLE](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/environment_variables/)

## How to specify Python Dependencies in Java/Scala Program  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/dependency_management/\#how-to-specify-python-dependencies-in-javascala-program)
...
You can refer to the SQL statement about [CREATE FUNCTION](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/create/#create-function)
for more details on how to create Python user-defined functions using SQL statements.

The Python dependencies could then be specified via the Python [config options](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/python/python_config/#python-options),
such as **python.archives**, **python.files**, **python.requirements**, **python.client.executable**,
**python.executable**. etc or through [command line arguments](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/cli/#usage)
when submitting the job.