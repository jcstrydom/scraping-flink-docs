...
|     |     |
| --- | --- |
| [ApacheLicenseResourceTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#ApacheLicenseResourceTransformer) | Prevents license duplication |
| [ApacheNoticeResourceTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#ApacheNoticeResourceTransformer) | Prepares merged NOTICE |
| [AppendingTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#AppendingTransformer) | Adds content to a resource |
| [ComponentsXmlResourceTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#ComponentsXmlResourceTransformer) | Aggregates Plexus `components.xml` |
| [DontIncludeResourceTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#DontIncludeResourceTransformer) | Prevents inclusion of matching resources |
| [GroovyResourceTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#GroovyResourceTransformer) | Merges Apache Groovy extends modules |
| [IncludeResourceTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#IncludeResourceTransformer) | Adds files from the project |
| [ManifestResourceTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#ManifestResourceTransformer) | Sets entries in the `MANIFEST` |
| [PluginXmlResourceTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#PluginXmlResourceTransformer) | Aggregates Mavens `plugin.xml` |
| [ResourceBundleAppendingTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#ResourceBundleAppendingTransformer) | Merges ResourceBundles |
| [ServicesResourceTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#ServicesResourceTransformer) | Relocated class names in `META-INF/services` resources and merges them. |
| [XmlAppendingTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#XmlAppendingTransformer) | Adds XML content to an XML resource |

Transformers in `org.apache.maven.plugins.shade.resource`

|     |     |
| --- | --- |
| [PropertiesTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#PropertiesTransformer) | Merges properties files owning an ordinal to solve conflicts |
| [OpenWebBeansPropertiesTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#OpenWebBeansPropertiesTransformer) | Merges Apache OpenWebBeans configuration files |
| [MicroprofileConfigTransformer](https://maven.apache.org/plugins/maven-shade-plugin/examples/resource-transformers.html#MicroprofileConfigTransformer) | Merges conflicting Microprofile Config properties based on an ordinal |
...
With [Plugin Tools 3.0](http://maven.apache.org/plugin-tools/index.html) annotations have been introduced. Now references to classes are no longer classnames as String, but the actual Class reference. When you wanted to relocate classes, you had to maintain the `META-INF/maven/plugin.xml` by hand, but now this can be done with the `PluginXmlResourceTransformer`
...
Some open source producers (including the [Apache Software Foundation](https://www.apache.org/)) include a copy of their license in the META-INF directory. These are conventionally named either `LICENSE`,`LICENSE.txt` or `LICENSE.md`. When merging these dependencies, adding these resources may cause confusion. The `ApacheLicenseResourceTransformer` ensures that duplicate licenses (named according to this convention) are not merged.
