...
## Reporting a vulnerability [¶](https://www.apache.org/security/\#reporting-a-vulnerability "Permalink")
...
**services to [root@apache.org](mailto:root@apache.org). (This includes issues with apache.org websites)**
...
## Issues not considered as security vulnerabilities [¶](https://www.apache.org/security/\#non-issues "Permalink")
...
## Vulnerability Information [¶](https://www.apache.org/security/\#vulnerability-information "Permalink")
...
security information pages for Apache projects](https://www.apache.org/security/projects.html). If you can't find the information you are looking for on the
...
## Vulnerability handling [¶](https://www.apache.org/security/\#vulnerability-handling "Permalink")
...
Committers should read a [more detailed description of the process](https://www.apache.org/security/committers.html). Reporters of security vulnerabilities may also find
it useful.

## Discussion [¶](https://www.apache.org/security/\#discussion "Permalink")
