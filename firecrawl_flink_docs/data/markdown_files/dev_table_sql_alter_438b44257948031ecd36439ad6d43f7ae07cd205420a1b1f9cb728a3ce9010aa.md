# ALTER Statements  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#alter-statements)

ALTER statements are used to modify the definition of a table, view or function that has already been registered in the [Catalog](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/catalogs/), or the definition of a catalog itself.
...
## Run an ALTER statement  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#run-an-alter-statement)
...
ALTER statements can be executed in [SQL CLI](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sqlclient/).
...
## ALTER TABLE  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#alter-table)
...
### ADD  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#add)

Use `ADD` clause to add [columns](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/#columns), [constraints](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/#primary-key), a [watermark](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/#watermark), [partitions](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/#partitioned-by), and a [distribution](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/#distributed) to an existing table.
...
### MODIFY  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#modify)
...
### DROP  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#drop)
...
### RENAME  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#rename)
...
### SET  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#set)
...
### RESET  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#reset)
...
## ALTER VIEW  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#alter-view)
...
## ALTER DATABASE  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#alter-database)
...
## ALTER FUNCTION  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#alter-function)
...
## ALTER CATALOG  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#alter-catalog)
...
### SET  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#set-1)
...
### RESET  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#reset-1)
...
### COMMENT  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#comment)
...
## ALTER MODEL  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#alter-model)
...
### SET  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#set-2)
...
### RESET  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#reset-2)
...
### RENAME TO  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/\#rename-to)
