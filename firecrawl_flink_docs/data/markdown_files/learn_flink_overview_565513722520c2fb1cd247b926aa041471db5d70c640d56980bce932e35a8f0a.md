> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/overview/).

# Learn Flink: Hands-On Training  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/learn-flink/overview/\#learn-flink-hands-on-training)

## Goals and Scope of this Training  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/learn-flink/overview/\#goals-and-scope-of-this-training)
...
## Stream Processing  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/learn-flink/overview/\#stream-processing)
...
![Bounded vs Unbounded](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/learn-flink/bounded-unbounded.png)
...
![Flink Application Sources and Sinks](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/learn-flink/flink-application-sources-sinks.png)

### Parallel Dataflows  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/learn-flink/overview/\#parallel-dataflows)
...
![Parallel Dataflow](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/learn-flink/parallel_dataflow.svg)
...
## Timely Stream Processing  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/learn-flink/overview/\#timely-stream-processing)
...
## Stateful Stream Processing  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/learn-flink/overview/\#stateful-stream-processing)
...
![Parallel Job](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/learn-flink/parallel-job.png)
...
![Local State](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/learn-flink/local-state.png)

## Fault Tolerance via State Snapshots  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/learn-flink/overview/\#fault-tolerance-via-state-snapshots)
