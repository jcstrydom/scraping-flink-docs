> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/configuration/maven/).

# How to use Maven to configure your project  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/configuration/maven/\#how-to-use-maven-to-configure-your-project)
...
## Requirements  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/configuration/maven/\#requirements)

- Maven 3.8.6
- Java 8 (deprecated) or Java 11

## Importing the project into your IDE  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/configuration/maven/\#importing-the-project-into-your-ide)
...
## Building the project  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/configuration/maven/\#building-the-project)
...
## Adding dependencies to the project  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/configuration/maven/\#adding-dependencies-to-the-project)
...
**Important:** Note that all these core API dependencies should have their scope set to [_provided_](https://maven.apache.org/guides/introduction/introduction-to-dependency-mechanism.html#dependency-scope). This means that
...
## Packaging the application  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/configuration/maven/\#packaging-the-application)
...
## Template for creating an uber/fat JAR with dependencies  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/configuration/maven/\#template-for-creating-an-uberfat-jar-with-dependencies)
