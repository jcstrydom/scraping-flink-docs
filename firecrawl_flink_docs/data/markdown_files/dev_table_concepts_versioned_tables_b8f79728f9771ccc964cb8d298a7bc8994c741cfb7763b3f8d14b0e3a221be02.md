> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/versioned_tables/).

# Versioned Tables  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/concepts/versioned_tables/\#versioned-tables)
...
## Concept  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/concepts/versioned_tables/\#concept)
...
## Versioned Table Sources  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/concepts/versioned_tables/\#versioned-table-sources)

Versioned tables are defined implicitly for any tables whose underlying sources or formats directly define changelogs.
Examples include the [upsert Kafka](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/table/upsert-kafka/) source as well as database changelog
formats such as [debezium](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/table/formats/debezium/) and [canal](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/table/formats/canal/).
...
## Versioned Table Views  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/concepts/versioned_tables/\#versioned-table-views)
...
The table `currency_rates` contains a row for each currency — with respect to USD —
...
Flink can reinterpret this table as a versioned table by defining a [deduplication query](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/deduplication/#deduplication)
which produces an ordered changelog stream with an inferred primary key (currency) and event time (update\_time).
...
- `ORDER BY time_attr DESC`: Specifies the ordering column, it must be a [time attribute](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/concepts/time_attributes/).
