# Vectorized User-defined Functions  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/vectorized_python_udfs/\#vectorized-user-defined-functions)
...
[non-vectorized user-defined functions](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/) on how to define vectorized user-defined functions.
...
## Vectorized Scalar Functions  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/vectorized_python_udfs/\#vectorized-scalar-functions)
...
[python.fn-execution.arrow.batch.size](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/python_config/#python-fn-execution-arrow-batch-size) for more details
...
## Vectorized Aggregate Functions  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/vectorized_python_udfs/\#vectorized-aggregate-functions)
...
to [the relevant documentation](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/tableapi/?code_tab=python#aggregations).
