> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/datastream/execution_mode/).

# Execution Mode (Batch/Streaming)  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#execution-mode-batchstreaming)
...
_final_ results regardless of the configured execution mode. It is important to
note what _final_ means here: a job executing in `STREAMING` mode might produce
...
## When can/should I use BATCH execution mode?  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#when-canshould-i-use-batch-execution-mode)
...
## Configuring BATCH execution mode  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#configuring-batch-execution-mode)
...
## Execution Behavior  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#execution-behavior)
...
### Task Scheduling And Network Shuffle  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#task-scheduling-and-network-shuffle)
...
[chaining](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/operators/overview/#task-chaining-and-resource-groups).
...
![Example Job Graph](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/datastream-example-job-graph.svg)

#### STREAMING Execution Mode  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#streaming-execution-mode)
...
#### BATCH Execution Mode  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#batch-execution-mode)
...
consuming _pipelined regions_ have produced their output.) After
...
### State Backends / State  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#state-backends--state)

In `STREAMING` mode, Flink uses a [StateBackend](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state_backends/) to control how state is stored and how
checkpointing works.
...
### Order of Processing  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#order-of-processing)
...
State](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/broadcast_state/))
...
### Event Time / Watermarks  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#event-time--watermarks)

When it comes to supporting [event time](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/event-time/generating_watermarks/), Flink’s
...
called [Watermarks](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/concepts/time/#event-time-and-watermarks).
...
is not keyed. Based on this scheme, all registered timers will fire at the _end_
_of time_ and user-defined `WatermarkAssigners` or `WatermarkGenerators` are
...
### Processing Time  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#processing-time)
...
unbounded input in _real time_ so there is a correlation between event time and
...
execution of a job and we fast-forward to the _end of time_ when the whole
input is processed.

### Failure Recovery  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#failure-recovery)

In `STREAMING` execution mode, Flink uses checkpoints for failure recovery.
Take a look at the [checkpointing documentation](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/checkpointing/) for hands-on documentation about this and
how to configure it. There is also a more introductory section about [fault\\
tolerance via state snapshots](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/learn-flink/fault_tolerance/) that
...
## Important Considerations  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#important-considerations)
...
- “Rolling” operations such as [reduce()](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/operators/overview/#reduce)
...
### Checkpointing  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#checkpointing)

As explained [above](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/#failure-recovery), failure recovery for batch programs
does not use checkpointing.

It is important to remember that because there are no checkpoints, certain
features such as
[CheckpointListener](https://nightlies.apache.org/flink/flink-docs-release-1.20/api/java//org/apache/flink/api/common/state/CheckpointListener.html)

and, as a result, Kafka’s [EXACTLY\_ONCE](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/datastream/kafka/#kafka-producers-and-fault-tolerance) mode or `File Sink`’s
[OnCheckpointRollingPolicy](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/datastream/filesystem/#rolling-policy)
...
You can still use all the [state primitives](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/state/#working-with-state),
it’s just that the mechanism used for failure recovery will be different.

### Writing Custom Operators  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/execution_mode/\#writing-custom-operators)
