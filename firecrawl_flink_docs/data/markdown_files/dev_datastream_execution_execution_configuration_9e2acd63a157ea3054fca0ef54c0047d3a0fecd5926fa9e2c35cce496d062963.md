# Execution Configuration  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/execution/execution_configuration/\#execution-configuration)
...
To change the defaults that affect all jobs, see [Configuration](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/).
