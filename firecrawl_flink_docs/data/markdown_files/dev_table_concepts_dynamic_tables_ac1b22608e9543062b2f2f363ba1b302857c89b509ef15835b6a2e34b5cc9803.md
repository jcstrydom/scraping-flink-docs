# Dynamic Tables  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/dynamic_tables/\#dynamic-tables)
...
## Relational Queries on Data Streams  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/dynamic_tables/\#relational-queries-on-data-streams)
...
## Dynamic Tables & Continuous Queries  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/dynamic_tables/\#dynamic-tables-amp-continuous-queries)
...
![Dynamic tables](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/table-streaming/stream-query-stream.png)
...
## Defining a Table on a Stream  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/dynamic_tables/\#defining-a-table-on-a-stream)
...
![Append mode](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/table-streaming/append-mode.png)

> Remember, a table defined on a stream is internally not materialized.

### Continuous Queries  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/dynamic_tables/\#continuous-queries)
...
![Continuous Non-Windowed Query](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/table-streaming/query-groupBy-cnt.png)
...
The second query is similar to the first one but groups the `clicks` table in addition to the `user` attribute also on an [hourly tumbling window](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/queries/window-agg/#group-window-functions) before it counts the number of URLs (time-based computations such as windows are based on special [time attributes](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/concepts/time_attributes/) are discussed later). Again, the figure shows the input and output at different points in time to visualize the changing nature of dynamic tables.

![Continuous Group-Window Query](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/table-streaming/query-groupBy-window-cnt.png)
...
### Update and Append Queries  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/dynamic_tables/\#update-and-append-queries)
...
- The conversion of an append-only table into a stream is different from the conversion of an updated table (see the [Table to Stream Conversion](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/dynamic_tables/#table-to-stream-conversion) section).

### Query Restrictions  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/dynamic_tables/\#query-restrictions)
...
The [Query Configuration](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/config/) page discusses parameters to control the execution of continuous queries. Some parameters can be used to trade the size of the maintained state for result accuracy.

## Table to Stream Conversion  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/dynamic_tables/\#table-to-stream-conversion)
...
![Dynamic tables](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/table-streaming/undo-redo-mode.png)
...
![Dynamic tables](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/table-streaming/redo-mode.png)

The API to convert a dynamic table into a `DataStream` is discussed on the [Common Concepts](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/common/#convert-a-table-into-a-datastream) page. Please note that only append and retract streams are supported when converting a dynamic table into a `DataStream`. The `TableSink` interface to emit a dynamic table to an external system are discussed on the [TableSources and TableSinks](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sourcessinks/#dynamic-table-sink) page.