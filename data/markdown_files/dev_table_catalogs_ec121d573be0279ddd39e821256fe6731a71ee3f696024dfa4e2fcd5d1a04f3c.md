# Catalogs  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#catalogs)
...
## Catalog Types  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#catalog-types)

### GenericInMemoryCatalog  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#genericinmemorycatalog)
...
### JdbcCatalog  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#jdbccatalog)
...
See [JdbcCatalog documentation](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/connectors/table/jdbc/) for more details on setting up the catalog.

### HiveCatalog  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#hivecatalog)
...
Flink’s [Hive documentation](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/connectors/table/hive/overview/) provides full details on setting up the catalog and interfacing with an existing Hive installation.
...
### User-Defined Catalog  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#user-defined-catalog)
...
#### Interface in Catalog for supporting time travel  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#interface-in-catalog-for-supporting-time-travel)

Starting from version 1.18, the Flink framework supports [time travel](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/queries/time-travel/) to query historical data of a table. To query the historical data of a table, users should implement `getTable(ObjectPath tablePath, long timestamp)` method for the catalog that the table belongs to.
...
## How to Create and Register Flink Tables to Catalog  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#how-to-create-and-register-flink-tables-to-catalog)

### Using SQL DDL  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#using-sql-ddl)
...
For detailed information, please check out [Flink SQL CREATE DDL](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/).

### Using Java, Scala or Python  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#using-java-scala-or-python)
...
## Catalog API  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#catalog-api)

Note: only catalog program APIs are listed here. Users can achieve many of the same functionalities with SQL DDL.
For detailed DDL information, please refer to [SQL CREATE DDL](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/).

### Database operations  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#database-operations)
...
### Table operations  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#table-operations)
...
### View operations  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#view-operations)
...
### Partition operations  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#partition-operations)
...
### Function operations  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#function-operations)
...
## Table API and SQL for Catalog  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#table-api-and-sql-for-catalog)

### Registering a Catalog  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#registering-a-catalog)
...
### Changing the Current Catalog And Database  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#changing-the-current-catalog-and-database)
...
### List Available Catalogs  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#list-available-catalogs)
...
### List Available Databases  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#list-available-databases)
...
### List Available Tables  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#list-available-tables)
...
## Catalog Modification Listener  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#catalog-modification-listener)
...
### Implement Catalog Listener  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#implement-catalog-listener)
...
### Register Catalog Listener  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#register-catalog-listener)
...
For sql-gateway, you can add the option `table.catalog-modification.listeners` in the [Flink configuration file](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/#flink-configuration-file)
...
## Catalog Store  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#catalog-store)
...
### Configure Catalog Store  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#configure-catalog-store)
...
### Catalog Store Type  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#catalog-store-type)
...
#### GenericInMemoryCatalogStore  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#genericinmemorycatalogstore)
...
#### FileCatalogStore  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#filecatalogstore)
...
The `FileCatalogStore` implementation supports both local and remote file systems that are available via the [Flink `FileSystem` abstraction](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/filesystems/overview/).
...
#### Catalog Store Configuration  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#catalog-store-configuration)

The following options can be used to adjust the Catalog Store behavior.

| Key | Default | Type | Description |
| --- | --- | --- | --- |
| ##### table.catalog-store.kind [Anchor link for: table catalog store kind](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#table-catalog-store-kind) | "generic\_in\_memory" | String | The kind of catalog store to be used. Out of the box, 'generic\_in\_memory' and 'file' options are supported. |
| ##### table.catalog-store.file.path [Anchor link for: table catalog store file path](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#table-catalog-store-file-path) | (none) | String | The configuration option for specifying the path to the file catalog store root directory. |

#### Custom Catalog Store  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/catalogs/\#custom-catalog-store)
