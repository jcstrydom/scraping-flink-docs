# Data Pipelines & ETL  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#data-pipelines--etl)
...
Note that Flink’s [Table and SQL APIs](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/overview/)
...
## Stateless Transformations  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#stateless-transformations)
...
[flink-training-repo](https://github.com/apache/flink-training/tree/release-2.2/)

.

### `map()` [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#map)
...
### `flatmap()` [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#flatmap)
...
## Keyed Streams  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#keyed-streams)

### `keyBy()` [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#keyby)
...
![keyBy and network shuffle](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/keyBy.png)

### Keys are computed  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#keys-are-computed)
...
### Aggregations on Keyed Streams  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#aggregations-on-keyed-streams)
...
### (Implicit) State  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#implicit-state)
...
### `reduce()` and other aggregators  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#reduce-and-other-aggregators)
...
## Stateful Transformations  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#stateful-transformations)

### Why is Flink Involved in Managing State?  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#why-is-flink-involved-in-managing-state)
...
### Rich Functions  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#rich-functions)
...
### An Example with Keyed State  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#an-example-with-keyed-state)
...
### Clearing State  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#clearing-state)
...
There’s also a [State Time-to-Live (TTL)](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/fault-tolerance/state/#state-time-to-live-ttl) option that you can configure with the state descriptor that specifies
when you want the state for stale keys to be automatically cleared.

### Non-keyed State  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#non-keyed-state)

It is also possible to work with managed state in non-keyed contexts. This is sometimes called
[operator state](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/fault-tolerance/state/#operator-state). The
...
## Connected Streams  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#connected-streams)

Sometimes instead of applying a pre-defined transformation like this:

![simple transformation](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/transformation.svg)
...
![connected streams](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/connected-streams.svg)

Connected streams can also be used to implement streaming joins.

### Example  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#example)
...
[InputSelectable](https://nightlies.apache.org/flink/flink-docs-release-2.2/api/java//org/apache/flink/streaming/api/operators/InputSelectable.html)
...
[Rides and Fares](https://github.com/apache/flink-training/blob/release-2.2//rides-and-fares)
.

## Further Reading  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/etl/\#further-reading)
