> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/connectors/datastream/hybridsource/).

# Hybrid Source  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/datastream/hybridsource/\#hybrid-source)

`HybridSource` is a source that contains a list of concrete [sources](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/sources/).
...
## Start position for next source  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/datastream/hybridsource/\#start-position-for-next-source)
...
#### Fixed start position at graph construction time  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/datastream/hybridsource/\#fixed-start-position-at-graph-construction-time)
...
#### Dynamic start position at switch time  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/datastream/hybridsource/\#dynamic-start-position-at-switch-time)
