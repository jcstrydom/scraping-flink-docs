# Docker Setup  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#docker-setup)

## Getting Started  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#getting-started)
...
### Introduction  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#introduction)
...
You can use the Docker images to deploy a _Session_ or _Application cluster_ on Docker. This page focuses on the setup of Flink on Docker and Docker Compose.

Deployment into managed containerized environments, such as [standalone Kubernetes](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/kubernetes/) or [native Kubernetes](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/native_kubernetes/), are described on separate pages.

### Starting a Session Cluster on Docker  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#starting-a-session-cluster-on-docker)

A _Flink Session cluster_ can be used to run multiple jobs. Each job needs to be submitted to the cluster after the cluster has been deployed.
To deploy a _Flink Session cluster_ with Docker, you need to start a JobManager container. To enable communication between the containers, we first set a required Flink configuration property and create a network:
...
## Deployment Modes  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#deployment-modes)
...
- [JobManager](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/concepts/glossary/#flink-jobmanager) for [a Session cluster](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#starting-a-session-cluster-on-docker)
- [JobManager](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/concepts/glossary/#flink-jobmanager) for [an Application cluster](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#application-mode-on-docker)
- [TaskManager](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/concepts/glossary/#flink-taskmanager) for any cluster
...
- [in a Kubernetes cluster](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/kubernetes/),
- [with Docker Compose](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#flink-with-docker-compose),

Note [The native Kubernetes](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/native_kubernetes/) also runs the same image by default
...
We recommend using [Docker Compose](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#flink-with-docker-compose) for deploying Flink in Session Mode to ease system configuration.

### Application Mode  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#application-mode)

> For high-level intuition behind the application mode, please refer to the [deployment mode overview](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/overview/#application-mode).

A _Flink Application cluster_ is a dedicated cluster which runs a single job.
...
$ docker run \
      ...
      --name=jobmanager \
      --network flink-network \
      flink:2.2.0-scala_2.12 standalone-job \
...
#### JobManager additional command line arguments  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#jobmanager-additional-command-line-arguments)
...
You can specify this argument to point the job artifacts stored in [flink filesystem](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/filesystems/overview/) or download via HTTP(S).
...
### Session Mode  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#session-mode)

> For high-level intuition behind the session mode, please refer to the [deployment mode overview](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/overview/#session-mode).

Local deployment in the Session Mode has already been described in the [Getting Started](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#starting-a-session-cluster-on-docker) section above.

## Flink Docker Images  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#flink-docker-images)

### Image Hosting  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#image-hosting)
...
### Image Tags  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#image-tags)
...
## Flink with Docker Compose  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#flink-with-docker-compose)
...
### General  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#general)

- Create the docker-compose.yaml file. Please check the examples in the sections below:
  - [Application Mode](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#app-cluster-yml)
  - [Session Mode](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#session-cluster-yml)
  - [Session Mode with SQL Client](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#session-cluster-sql-yaml)
...
### Application Mode  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#application-mode-1)
...
Please check [here](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#application-mode) for the details.
See also [how to specify the JobManager arguments](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#jobmanager-additional-command-line-arguments) in the `command` for the `jobmanager` service.
...
### Session Mode  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#session-mode-1)
...
### Flink SQL Client with Session Cluster  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#flink-sql-client-with-session-cluster)
...
## Using Flink Python on Docker  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#using-flink-python-on-docker)
...
## Configuring Flink on Docker  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#configuring-flink-on-docker)

### Via dynamic properties  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#via-dynamic-properties)

```sh
$ docker run flink:2.2.0-scala_2.12 \
...
Options set via dynamic properties overwrite the options from [Flink configuration file](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/#flink-configuration-file).

### Via Environment Variables  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#via-environment-variables)
...
The [`jobmanager.rpc.address`](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/#jobmanager-rpc-address) option must be configured, others are optional to set.
...
the same way as in the [Flink configuration file](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/#flink-configuration-file). `FLINK_PROPERTIES` takes precedence over configurations in [Flink configuration file](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/#flink-configuration-file).

### Via Flink configuration file  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#via-flink-configuration-file)

The configuration files ( [Flink configuration file](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/#flink-configuration-file), logging, hosts etc) are located in the `/opt/flink/conf` directory in the Flink image.
...
$ docker run \
      ...
      flink:2.2.0-scala_2.12 <jobmanager|standalone-job|taskmanager>
```
...
> The [Flink configuration file](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/#flink-configuration-file) must have write permission so that the Docker entry point script can modify it in certain cases.

### Using Filesystem Plugins  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#using-filesystem-plugins)

As described in the [plugins](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/filesystems/plugins/) documentation page: In order to use plugins they must be
...
The `ENABLE_BUILT_IN_PLUGINS` should contain a list of plugin jar file names separated by `;`. A valid plugin name is for example `flink-s3-fs-hadoop-2.2.0.jar`
...
There are also more [advanced ways](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#advanced-customization) for customizing the Flink image.

### Switching the Memory Allocator  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#switching-the-memory-allocator)
...
### Further Customization  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/\#further-customization)
...
as described in [supported deployment modes](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/resource-providers/standalone/docker/#deployment-modes).
...
$ docker run \
      ...
      flink:2.2.0-scala_2.12 /mnt/custom_entry_point_script.sh
```
