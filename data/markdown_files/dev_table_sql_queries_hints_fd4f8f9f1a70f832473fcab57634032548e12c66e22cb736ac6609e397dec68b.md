> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/queries/hints/).

# SQL Hints  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#sql-hints)
...
## Dynamic Table Options  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#dynamic-table-options)
...
### Syntax  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#syntax)
...
### Examples  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples)
...
## Query Hints  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#query-hints)

`Query hints` can be used to suggest the optimizer to affect query execution plan within a specified query scope.
Their effective scope is current `Query block`( [What are query blocks ?](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/#what-are-query-blocks-)) which `Query Hints` are specified.
Now, Flink `Query Hints` only support `Join Hints`.

### Syntax  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#syntax-1)
...
### Conflict Cases In Query Hints  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#conflict-cases-in-query-hints)

#### Resolution of Key-value Hint Conflicts  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#resolution-of-key-value-hint-conflicts)
...
#### Resolution of List Hint Conflicts  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#resolution-of-list-hint-conflicts)
...
### Join Hints  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#join-hints)
...
> - For multiple tables in a single Join Hints or multiple Join Hints in a hint block, Flink Join Hints may conflict. If the conflicts occur, Flink will choose the most matching table or join strategy. (See: [Conflict Cases In Join Hints](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/#conflict-cases-in-join-hints))

#### BROADCAST  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#broadcast)
...
##### Examples  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples-1) [Anchor link for: examples 1](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples-1)
...
#### SHUFFLE\_HASH  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#shuffle_hash)
...
> Note: SHUFFLE\_HASH only supports join with equivalence join condition.

##### Examples  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples-2) [Anchor link for: examples 2](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples-2)
...
#### SHUFFLE\_MERGE  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#shuffle_merge)
...
> Note: SHUFFLE\_MERGE only supports join with equivalence join condition.

##### Examples  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples-3) [Anchor link for: examples 3](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples-3)
...
#### NEST\_LOOP  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#nest_loop)
...
> Note: NEST\_LOOP supports both equivalent and non-equivalent join condition.

##### Examples  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples-4) [Anchor link for: examples 4](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples-4)
...
#### LOOKUP  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#lookup)
...
#### LOOKUP Hint Options:  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#lookup-hint-options)
...
| async | async | N | boolean | N/A | value can be 'true' or 'false' to suggest the planner choose the corresponding lookup function.<br> If the backend lookup source does not support the suggested lookup mode, it will take no effect. |
| output-mode | N | string | ordered | value can be 'ordered' or 'allow\_unordered'.<br>'allow\_unordered' means if users allow unordered result, it will attempt to use AsyncDataStream.OutputMode.UNORDERED when it does not affect the correctness of the result, otherwise ORDERED will be still used. It is consistent with <br>\`ExecutionConfigOptions#TABLE\_EXEC\_ASYNC\_LOOKUP\_OUTPUT\_MODE\`. |
...
| retry | retry-predicate | N | string | N/A | can be 'lookup\_miss' which will enable retry if lookup result is empty. |
| retry-strategy | N | string | N/A | can be 'fixed\_delay' |
| fixed-delay | N | duration | N/A | delay time for the 'fixed\_delay' strategy |
| max-attempts | N | integer | N/A | max attempt number of the 'fixed\_delay' strategy |
...
#### 1\. Use Sync And Async Lookup Function  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#1-use-sync-and-async-lookup-function)
...
> 2. user enables ‘TRY\_RESOLVE’ mode of [’table.optimizer.non-deterministic-update.strategy’](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/config/#table-optimizer-non-deterministic-update-strategy) and the
>    optimizer has checked there’s correctness issue caused by non-deterministic update.

#### 2\. Configure The Async Parameters  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#2-configure-the-async-parameters)
...
> Note: the async options are consistent with the async options in [job level Execution Options](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/config/#execution-options),
...
#### 3\. Enable Delayed Retry Strategy For Lookup  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#3-enable-delayed-retry-strategy-for-lookup)

Delayed retry for lookup join is intended to solve the problem of delayed updates in external system
which cause unexpected enrichment with stream data. The hint option ‘retry-predicate’=‘lookup\_miss’
...
#### Further Notes  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#further-notes)

#### Effect Of Enabling Caching On Retries  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#effect-of-enabling-caching-on-retries)
...
#### Note On Lookup Keys And ‘retry-predicate’=‘lookup\_miss’ Retry Conditions  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#note-on-lookup-keys-and-retry-predicatelookup_miss-retry-conditions)
...
as the example of [`lookup join`](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/joins/#lookup-join), where
`c.id` is the lookup key of the join condition “ON o.customer\_id = c.id”:
...
if we change the join condition to “ON o.customer\_id = c.id and c.country = ‘US’"：
...
’lookup\_miss’ retry predicate and the fixed-delay retry strategy.
...
Currently, based on SQL semantic considerations, only the ’lookup\_miss’ retry predicate is provided,
...
#### Trouble Shooting  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#trouble-shooting)
...
#### Conflict Cases In Join Hints  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#conflict-cases-in-join-hints)

If the `Join Hints` conflicts occur, Flink will choose the most matching one.

- First, `Join Hints` will follow the logic of Flink query hint for resolving conflicts (see: [Conflict Cases In Query Hints](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/#conflict-cases-in-query-hints))
...
##### Examples  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples-5) [Anchor link for: examples 5](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples-5)
...
### State TTL Hints  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#state-ttl-hints)

Streaming

For stateful computation [Regular Join](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/joins/#regular-joins)
and [Group Aggregation](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/group-agg/), users can
use `STATE_TTL` hint to
specify operator-level [Idle State Retention Time](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/concepts/overview/#idle-state-retention-time),
which enables the aforementioned operators to have a different TTL against the pipeline level configuration [table.exec.state.ttl](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/config/#table-exec-state-ttl).

##### Regular Join Examples  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#regular-join-examples) [Anchor link for: regular join examples](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#regular-join-examples)
...
##### Group Aggregation Examples  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#group-aggregation-examples) [Anchor link for: group aggregation examples](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#group-aggregation-examples)
...
>   ```
>
> - STATE\_TTL hint only applies on the underlying query block.
...
### What are query blocks ?  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#what-are-query-blocks-)
...
#### Examples  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/hints/\#examples-6)
...
![hint where query block](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/hint/hint_query_block_where.png)
...
![hint union query block](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/hint/hint_query_block_union.png)

The query below contains a view, and it has two `query blocks` \- one for the outer `SELECT` and another for the view.

![hint view query block](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/hint/hint_query_block_view.png)