# EXPLAIN Statements  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/explain/\#explain-statements)

EXPLAIN statements are used to explain the logical and optimized query plans of a query or an INSERT statement.

## Run an EXPLAIN statement  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/explain/\#run-an-explain-statement)
...
EXPLAIN statements can be executed in [SQL CLI](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sqlclient/).
...
## ExplainDetails  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/explain/\#explaindetails)
...
Specify `CHANGELOG_MODE` will inform the optimizer to attach the changelog mode (see more details at [Dynamic Tables](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/concepts/dynamic_tables/#table-to-stream-conversion)) of each physical rel node to the ouptput.
...
| --- | --- |
| QUERY\_LEVEL | It provides advice from a global view, targeting the entire query |
| NODE\_LEVEL | It provides advice to a specific rel node |

Flink SQL provides the plan advice targeting the following issues

- Data Skewness caused by Group Aggregation (see more details at [Group Aggregation](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/queries/group-agg/#group-aggregation) and [Performance Tuning](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/tuning/#local-global-aggregation))
- Non-deterministic Updates ( _abbr._ NDU, see more details at [Determinism In Continuous Queries](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/concepts/determinism/#3-determinism-in-streaming-processing))
...
## Syntax  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/explain/\#syntax)
...
For query syntax, please refer to [Queries](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/queries/overview/) page.
For insert syntax, please refer to [INSERT](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/insert/) page.