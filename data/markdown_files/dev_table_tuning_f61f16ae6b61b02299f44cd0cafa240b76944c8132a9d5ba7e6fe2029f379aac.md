> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/tuning/).

# Performance Tuning  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/tuning/\#performance-tuning)
...
> The streaming aggregation optimizations mentioned in this page are all supported for [Group Aggregations](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/group-agg/) and [Window TVF Aggregations](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/window-agg/) (except Session Window TVF Aggregation) now.

## MiniBatch Aggregation  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/tuning/\#minibatch-aggregation)
...
![](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/table-streaming/minibatch_agg.png)

MiniBatch optimization is disabled by default for group aggregation. In order to enable this optimization, you should set options `table.exec.mini-batch.enabled`, `table.exec.mini-batch.allow-latency` and `table.exec.mini-batch.size`. Please see [configuration](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/config/#execution-options) page for more details.

> MiniBatch optimization is always enabled for [Window TVF Aggregation](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/queries/window-agg/), regardless of the above configuration.
> Window TVF aggregation buffer records in [managed memory](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/memory/mem_setup_tm/#managed-memory) instead of JVM Heap, so there is no risk of overloading GC or OOM issues.
...
## Local-Global Aggregation  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/tuning/\#local-global-aggregation)
...
![](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/table-streaming/local_agg.png)
...
## Split Distinct Aggregation  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/tuning/\#split-distinct-aggregation)
...
The following figure shows how the split distinct aggregation improve performance (assuming color represents days, and letter represents user\_id).

![](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/table-streaming/distinct_split.png)
...
## Use FILTER Modifier on Distinct Aggregates  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/tuning/\#use-filter-modifier-on-distinct-aggregates)
...
## MiniBatch Regular Joins  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/tuning/\#minibatch-regular-joins)
...
![](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/table-streaming/minibatch_join.png)

MiniBatch optimization is disabled by default for regular join. In order to enable this optimization, you should set options `table.exec.mini-batch.enabled`, `table.exec.mini-batch.allow-latency` and `table.exec.mini-batch.size`. Please see [configuration](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/config/#execution-options) page for more details.