...
If you're curious about more governance details, we have a description of [Apache style governance](https://www.apache.org/foundation/governance/).
...
- [What is the Apache Software Foundation?](https://www.apache.org/foundation/how-it-works/#what)

- [Meritocracy](https://www.apache.org/foundation/how-it-works/#meritocracy)

- [The Foundation structure](https://www.apache.org/foundation/how-it-works/#structure)

- [Roles](https://www.apache.org/foundation/how-it-works/#roles)

- [Project management and collaboration](https://www.apache.org/foundation/how-it-works/#management)

- [The Foundation Infrastructure](https://www.apache.org/foundation/how-it-works/#infrastructure)

- [The Foundation Incubator](https://www.apache.org/foundation/how-it-works/#incubator)

- [Other Foundation entities](https://www.apache.org/foundation/how-it-works/#other)

- [Conclusions](https://www.apache.org/foundation/how-it-works/#conclusions)


## What is the Apache Software Foundation? [¶](https://www.apache.org/foundation/how-it-works/\#what "Permalink")

The [Apache Software Foundation](https://www.apache.org/foundation/) (ASF) is a 501(c)3 non-profit public charity organization
...
## Meritocracy [¶](https://www.apache.org/foundation/how-it-works/\#meritocracy "Permalink")
...
## The Foundation structure [¶](https://www.apache.org/foundation/how-it-works/\#structure "Permalink")
...
For all the details, read our [Governance overview](https://www.apache.org/foundation/governance/).

### Board of Directors (board) [¶](https://www.apache.org/foundation/how-it-works/\#board "Permalink")
...
[Bylaws](https://www.apache.org/foundation/bylaws.html). This includes management of the corporate assets
...
### Project Management Committees (PMC) [¶](https://www.apache.org/foundation/how-it-works/\#pmc "Permalink")
...
We firmly believe in [hats](https://www.apache.org/foundation/how-it-works/#hats). Your role at the ASF is one assigned to
...
### Officers [¶](https://www.apache.org/foundation/how-it-works/\#officers "Permalink")

The [Officers of the Apache Software Foundation](https://www.apache.org/foundation/how-it-works/) oversee the day-to-day
affairs of the Foundation. The [Board of\\
Directors](https://www.apache.org/foundation/how-it-works/#board) elects these officers.

## Roles [¶](https://www.apache.org/foundation/how-it-works/\#roles "Permalink")

The meritocracy typically has various roles within each individual Apache project community:

`user | developer | committer
| PMC member | PMC chair | ASF member`

### User [¶](https://www.apache.org/foundation/how-it-works/\#users "Permalink")
...
### Developer [¶](https://www.apache.org/foundation/how-it-works/\#developers "Permalink")
...
### Committer [¶](https://www.apache.org/foundation/how-it-works/\#committers "Permalink")

A **committer** is a developer who has write access to the code
repository and has a signed [Contributor License Agreement\\
(CLA)](https://www.apache.org/licenses/#clas) on file. They have an
...
### PMC Member [¶](https://www.apache.org/foundation/how-it-works/\#pmc-members "Permalink")
...
### PMC Chair [¶](https://www.apache.org/foundation/how-it-works/\#pmc-chair "Permalink")

The Board appoints the **Chair** of a PMC from the [PMC members](https://www.apache.org/foundation/how-it-works/#pmc-members). The PMC as a whole is the
...
### ASF Member [¶](https://www.apache.org/foundation/how-it-works/\#asf-members "Permalink")
...
## Project Management and collaboration [¶](https://www.apache.org/foundation/how-it-works/\#management "Permalink")
...
### Communication [¶](https://www.apache.org/foundation/how-it-works/\#communication "Permalink")
...
### Documentation [¶](https://www.apache.org/foundation/how-it-works/\#documentation "Permalink")
...
at [ASF Infrastructure](https://www.apache.org/dev/).

### Decision Making [¶](https://www.apache.org/foundation/how-it-works/\#decision-making "Permalink")
...
## Philosophy [¶](https://www.apache.org/foundation/how-it-works/\#philosophy "Permalink")
...
## Operation [¶](https://www.apache.org/foundation/how-it-works/\#operation "Permalink")
...
### Individuals compose the ASF [¶](https://www.apache.org/foundation/how-it-works/\#hats "Permalink")
...
list is done _as themselves_. It is the individual point-of-view, wearing
...
### Balancing confidentiality and public discussion [¶](https://www.apache.org/foundation/how-it-works/\#confidential "Permalink")
...
## The Foundation Infrastructure [¶](https://www.apache.org/foundation/how-it-works/\#infrastructure "Permalink")
...
The ASF Infrastructure team, known as "Infra", supports services that help the ASF and its projects function and flourish. [Learn more](https://apache.org/dev/infrastructure.html).

## The Foundation Incubator [¶](https://www.apache.org/foundation/how-it-works/\#incubator "Permalink")
...
## Other Foundation Entities [¶](https://www.apache.org/foundation/how-it-works/\#other "Permalink")
...
buildings. It's a virtual entity that exists only on the internet, and the [Infrastructure team](https://www.apache.org/dev/infrastructure.html) manages the
...
## In review... [¶](https://www.apache.org/foundation/how-it-works/\#conclusions "Permalink")

The ASF represents one of the best
examples of an open organization that has found balance between structure
and flexibility. We have grown from 200 committers to around 9800, and that
