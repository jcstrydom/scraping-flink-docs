# Checkpointing under backpressure  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/state/checkpointing_under_backpressure/\#checkpointing-under-backpressure)
...
[checkpointing process](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/concepts/stateful-stream-processing/#checkpointing)).
and can be observed by high
[alignment time and start delay metrics](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/monitoring/checkpoint_monitoring/#history-tab).
...
## Buffer debloating  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/state/checkpointing_under_backpressure/\#buffer-debloating)
...
[network memory tuning guide](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/memory/network_mem_tuning/).
...
[Unaligned checkpoints](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/concepts/stateful-stream-processing/#unaligned-checkpointing)
...
### Aligned checkpoint timeout  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/state/checkpointing_under_backpressure/\#aligned-checkpoint-timeout)
...
### Limitations  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/state/checkpointing_under_backpressure/\#limitations)

#### Concurrent checkpoints  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/state/checkpointing_under_backpressure/\#concurrent-checkpoints)
...
#### Interplay with watermarks  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/state/checkpointing_under_backpressure/\#interplay-with-watermarks)
...
#### Interplay with long-running record processing  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/state/checkpointing_under_backpressure/\#interplay-with-long-running-record-processing)
...
#### Certain data distribution patterns are not checkpointed  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/state/checkpointing_under_backpressure/\#certain-data-distribution-patterns-are-not-checkpointed)
...
![Pointwise connection](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/uc_pointwise.svg)
...
![Broadcast connection](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/uc_broadcast.svg)
...
### Troubleshooting  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/state/checkpointing_under_backpressure/\#troubleshooting)

#### Corrupted in-flight data  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/state/checkpointing_under_backpressure/\#corrupted-in-flight-data)
...
it is possible to use [recover-without-channel-state.checkpoint-id](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/#execution-checkpointing-recover-without-channel-state-checkpoint) property.
...
The property can be applied only after the job will be redeployed which means this operation makes sense only if [externalized checkpoint](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/fault-tolerance/checkpointing/#enabling-and-configuring-checkpointing) is enabled.