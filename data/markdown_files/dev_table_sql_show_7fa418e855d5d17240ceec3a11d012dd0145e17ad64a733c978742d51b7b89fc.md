> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/show/).

# SHOW Statements  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-statements)
...
## Run a SHOW statement  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#run-a-show-statement)
...
SHOW statements can be executed in [SQL CLI](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sqlclient/).
...
## SHOW CATALOGS  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-catalogs)
...
## SHOW CURRENT CATALOG  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-current-catalog)
...
## SHOW CREATE CATALOG  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-create-catalog)
...
## SHOW DATABASES  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-databases)
...
## SHOW CURRENT DATABASE  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-current-database)
...
## SHOW TABLES  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-tables)
...
### SHOW TABLES EXAMPLES  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-tables-examples)
...
## SHOW CREATE TABLE  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-create-table)
...
## SHOW COLUMNS  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-columns)
...
### SHOW COLUMNS EXAMPLES  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-columns-examples)
...
## SHOW PARTITIONS  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-partitions)
...
**PARTITION**
Show all the partitions which are under the provided <partition\_spec> in the given table.

### SHOW PARTITIONS EXAMPLES  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-partitions-examples)
...
## SHOW PROCEDURES  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-procedures)
...
## SHOW VIEWS  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-views)
...
## SHOW CREATE VIEW  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-create-view)
...
## SHOW FUNCTIONS  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-functions)
...
## SHOW MODULES  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-modules)
...
## SHOW JARS  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-jars)

```sql
SHOW JARS
```

Show all added jars in the session classloader which are added by [`ADD JAR`](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/jar/#add-jar) statements.

Attention Currently `SHOW JARS` statements only work in the [SQL CLI](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sqlclient/) or [SQL Gateway](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql-gateway/overview/).

## SHOW JOBS  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/show/\#show-jobs)
...
Attention Currently `SHOW JOBS` statements only work in the [SQL CLI](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sqlclient/) or [SQL Gateway](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql-gateway/overview/).