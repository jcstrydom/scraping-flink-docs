# General User-defined Functions  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/\#general-user-defined-functions)
...
## Scalar Functions  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/\#scalar-functions)
...
## Table Functions  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/\#table-functions)
...
## Aggregate Functions  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/\#aggregate-functions)

A user-defined aggregate function ( _UDAGG_) maps scalar values of multiple rows to a new scalar value.

**NOTE:** Currently the general user-defined aggregate function is only supported in the GroupBy aggregation and Group Window Aggregation in streaming mode. For batch mode, it’s currently not supported and it is recommended to use the [Vectorized Aggregate Functions](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/vectorized_python_udfs/#vectorized-aggregate-functions).
...
![UDAGG mechanism](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/udagg-mechanism-python.png)
...
### Mandatory and Optional Methods  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/\#mandatory-and-optional-methods)
...
### ListView and MapView  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/\#listview-and-mapview)
...
[documentation of the corresponding classes](https://nightlies.apache.org/flink/flink-docs-release-2.2/api/python//pyflink.table.html#pyflink.table.ListView)
...
For more details please refer to the [Python Configuration Documentation](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/python_config/).

## Table Aggregate Functions  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/\#table-aggregate-functions)
...
Similar to an [aggregate function](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/#aggregate-functions), the behavior of a table aggregate is centered around the concept of an accumulator.
...
![UDTAGG mechanism](https://nightlies.apache.org/flink/flink-docs-release-2.2/fig/udtagg-mechanism-python.png)
...
### Mandatory and Optional Methods  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/\#mandatory-and-optional-methods-1)
...
### ListView and MapView  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/\#listview-and-mapview-1)

Similar to [Aggregation function](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/python/table/udfs/python_udfs/#aggregate-functions), we can also use ListView and MapView in Table Aggregate Function.
