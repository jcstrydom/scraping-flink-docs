[Skip to main content](https://superset.apache.org/docs/configuration/databases/#__docusaurus_skipToContent_fallback)

This is unreleased documentation for Superset **Next** version.

For up-to-date documentation, see the **[latest version](https://superset.apache.org/docs/6.0.0/configuration/databases)** (6.0.0).
...
installation documentations ( [Docker Compose](https://superset.apache.org/docs/installation/docker-compose), [Kubernetes](https://superset.apache.org/docs/installation/kubernetes))

This documentation tries to keep pointer to the different drivers for commonly used database
engine.

## Installing Database Drivers [​](https://superset.apache.org/docs/configuration/databases/\#installing-database-drivers "Direct link to Installing Database Drivers")
...
You can read more [here](https://superset.apache.org/docs/configuration/databases#installing-drivers-in-docker-images) about how to
install new database drivers into your Superset configuration.

### Supported Databases and Dependencies [​](https://superset.apache.org/docs/configuration/databases/\#supported-databases-and-dependencies "Direct link to Supported Databases and Dependencies")
...
| --- | --- | --- |
| [AWS Athena](https://superset.apache.org/docs/configuration/databases#aws-athena) | `pip install pyathena[pandas]` , `pip install PyAthenaJDBC` | `awsathena+rest://{access_key_id}:{access_key}@athena.{region}.amazonaws.com/{schema}?s3_staging_dir={s3_staging_dir}&...` |
| [AWS DynamoDB](https://superset.apache.org/docs/configuration/databases#aws-dynamodb) | `pip install pydynamodb` | `dynamodb://{access_key_id}:{secret_access_key}@dynamodb.{region_name}.amazonaws.com?connector=superset` |
| [AWS Redshift](https://superset.apache.org/docs/configuration/databases#aws-redshift) | `pip install sqlalchemy-redshift` | `redshift+psycopg2://<userName>:<DBPassword>@<AWS End Point>:5439/<Database Name>` |
| [Apache Doris](https://superset.apache.org/docs/configuration/databases#apache-doris) | `pip install pydoris` | `doris://<User>:<Password>@<Host>:<Port>/<Catalog>.<Database>` |
| [Apache Drill](https://superset.apache.org/docs/configuration/databases#apache-drill) | `pip install sqlalchemy-drill` | `drill+sadrill://<username>:<password>@<host>:<port>/<storage_plugin>`, often useful: `?use_ssl=True/False` |
| [Apache Druid](https://superset.apache.org/docs/configuration/databases#apache-druid) | `pip install pydruid` | `druid://<User>:<password>@<Host>:<Port-default-9088>/druid/v2/sql` |
| [Apache Hive](https://superset.apache.org/docs/configuration/databases#hive) | `pip install pyhive` | `hive://hive@{hostname}:{port}/{database}` |
| [Apache Impala](https://superset.apache.org/docs/configuration/databases#apache-impala) | `pip install impyla` | `impala://{hostname}:{port}/{database}` |
| [Apache Kylin](https://superset.apache.org/docs/configuration/databases#apache-kylin) | `pip install kylinpy` | `kylin://<username>:<password>@<hostname>:<port>/<project>?<param1>=<value1>&<param2>=<value2>` |
| [Apache Pinot](https://superset.apache.org/docs/configuration/databases#apache-pinot) | `pip install pinotdb` | `pinot://BROKER:5436/query?server=http://CONTROLLER:5983/` |
| [Apache Solr](https://superset.apache.org/docs/configuration/databases#apache-solr) | `pip install sqlalchemy-solr` | `solr://{username}:{password}@{hostname}:{port}/{server_path}/{collection}` |
| [Apache Spark SQL](https://superset.apache.org/docs/configuration/databases#apache-spark-sql) | `pip install pyhive` | `hive://hive@{hostname}:{port}/{database}` |
| [Arc - Apache Arrow](https://superset.apache.org/docs/configuration/databases#arc-arrow) | `pip install arc-superset-arrow` | `arc+arrow://{api_key}@{hostname}:{port}/{database}` |
| [Arc - JSON](https://superset.apache.org/docs/configuration/databases#arc-json) | `pip install arc-superset-dialect` | `arc+json://{api_key}@{hostname}:{port}/{database}` |
| [Ascend.io](https://superset.apache.org/docs/configuration/databases#ascendio) | `pip install impyla` | `ascend://{username}:{password}@{hostname}:{port}/{database}?auth_mechanism=PLAIN;use_ssl=true` |
| [Azure MS SQL](https://superset.apache.org/docs/configuration/databases#sql-server) | `pip install pymssql` | `mssql+pymssql://UserName@presetSQL:TestPassword@presetSQL.database.windows.net:1433/TestSchema` |
| [ClickHouse](https://superset.apache.org/docs/configuration/databases#clickhouse) | `pip install clickhouse-connect` | `clickhousedb://{username}:{password}@{hostname}:{port}/{database}` |
| [Cloudflare D1](https://superset.apache.org/docs/configuration/databases#cloudflare-d1) | `pip install superset-engine-d1` or `pip install apache_superset[d1]` | `d1://{cloudflare_account_id}:{cloudflare_api_token}@{cloudflare_d1_database_id}` |
| [CockroachDB](https://superset.apache.org/docs/configuration/databases#cockroachdb) | `pip install cockroachdb` | `cockroachdb://root@{hostname}:{port}/{database}?sslmode=disable` |
| [Couchbase](https://superset.apache.org/docs/configuration/databases#couchbase) | `pip install couchbase-sqlalchemy` | `couchbase://{username}:{password}@{hostname}:{port}?truststorepath={ssl certificate path}` |
| [CrateDB](https://superset.apache.org/docs/configuration/databases#cratedb) | `pip install sqlalchemy-cratedb` | `crate://{username}:{password}@{hostname}:{port}`, often useful: `?ssl=true/false` or `?schema=testdrive`. |
| [Denodo](https://superset.apache.org/docs/configuration/databases#denodo) | `pip install denodo-sqlalchemy` | `denodo://{username}:{password}@{hostname}:{port}/{database}` |
| [Dremio](https://superset.apache.org/docs/configuration/databases#dremio) | `pip install sqlalchemy_dremio` | `dremio+flight://{username}:{password}@{host}:32010`, often useful: `?UseEncryption=true/false`. For Legacy ODBC: `dremio+pyodbc://{username}:{password}@{host}:31010` |
| [Elasticsearch](https://superset.apache.org/docs/configuration/databases#elasticsearch) | `pip install elasticsearch-dbapi` | `elasticsearch+http://{user}:{password}@{host}:9200/` |
| [Exasol](https://superset.apache.org/docs/configuration/databases#exasol) | `pip install sqlalchemy-exasol` | `exa+pyodbc://{username}:{password}@{hostname}:{port}/my_schema?CONNECTIONLCALL=en_US.UTF-8&driver=EXAODBC` |
| [Google BigQuery](https://superset.apache.org/docs/configuration/databases#google-bigquery) | `pip install sqlalchemy-bigquery` | `bigquery://{project_id}` |
| [Google Sheets](https://superset.apache.org/docs/configuration/databases#google-sheets) | `pip install shillelagh[gsheetsapi]` | `gsheets://` |
| [Firebolt](https://superset.apache.org/docs/configuration/databases#firebolt) | `pip install firebolt-sqlalchemy` | `firebolt://{client_id}:{client_secret}@{database}/{engine_name}?account_name={name}` |
| [Hologres](https://superset.apache.org/docs/configuration/databases#hologres) | `pip install psycopg2` | `postgresql+psycopg2://<UserName>:<DBPassword>@<Database Host>/<Database Name>` |
| [IBM Db2](https://superset.apache.org/docs/configuration/databases#ibm-db2) | `pip install ibm_db_sa` | `db2+ibm_db://` |
| [IBM Netezza Performance Server](https://superset.apache.org/docs/configuration/databases#ibm-netezza-performance-server) | `pip install nzalchemy` | `netezza+nzpy://<UserName>:<DBPassword>@<Database Host>/<Database Name>` |
| [MySQL](https://superset.apache.org/docs/configuration/databases#mysql) | `pip install mysqlclient` | `mysql://<UserName>:<DBPassword>@<Database Host>/<Database Name>` |
| [OceanBase](https://superset.apache.org/docs/configuration/databases#oceanbase) | `pip install oceanbase_py` | `oceanbase://<UserName>:<DBPassword>@<Database Host>/<Database Name>` |
| [Oracle](https://superset.apache.org/docs/configuration/databases#oracle) | `pip install oracledb` | `oracle://<username>:<password>@<hostname>:<port>` |
| [Parseable](https://superset.apache.org/docs/configuration/databases#parseable) | `pip install sqlalchemy-parseable` | `parseable://<UserName>:<DBPassword>@<Database Host>/<Stream Name>` |
| [PostgreSQL](https://superset.apache.org/docs/configuration/databases#postgres) | `pip install psycopg2` | `postgresql://<UserName>:<DBPassword>@<Database Host>/<Database Name>` |
| [Presto](https://superset.apache.org/docs/configuration/databases#presto) | `pip install pyhive` | `presto://{username}:{password}@{hostname}:{port}/{database}` |
| [SAP Hana](https://superset.apache.org/docs/configuration/databases#hana) | `pip install hdbcli sqlalchemy-hana` or `pip install apache_superset[hana]` | `hana://{username}:{password}@{host}:{port}` |
| [SingleStore](https://superset.apache.org/docs/configuration/databases#singlestore) | `pip install sqlalchemy-singlestoredb` | `singlestoredb://{username}:{password}@{host}:{port}/{database}` |
| [StarRocks](https://superset.apache.org/docs/configuration/databases#starrocks) | `pip install starrocks` | `starrocks://<User>:<Password>@<Host>:<Port>/<Catalog>.<Database>` |
| [Snowflake](https://superset.apache.org/docs/configuration/databases#snowflake) | `pip install snowflake-sqlalchemy` | `snowflake://{user}:{password}@{account}.{region}/{database}?role={role}&warehouse={warehouse}` |
| SQLite | No additional library needed | `sqlite://path/to/file.db?check_same_thread=false` |
| [SQL Server](https://superset.apache.org/docs/configuration/databases#sql-server) | `pip install pymssql` | `mssql+pymssql://<Username>:<Password>@<Host>:<Port-default:1433>/<Database Name>` |
| [TDengine](https://superset.apache.org/docs/configuration/databases#tdengine) | `pip install taospy``pip install taos-ws-py` | `taosws://<user>:<password>@<host>:<port>` |
| [Teradata](https://superset.apache.org/docs/configuration/databases#teradata) | `pip install teradatasqlalchemy` | `teradatasql://{user}:{password}@{host}` |
| [TimescaleDB](https://superset.apache.org/docs/configuration/databases#timescaledb) | `pip install psycopg2` | `postgresql://<UserName>:<DBPassword>@<Database Host>:<Port>/<Database Name>` |
| [Trino](https://superset.apache.org/docs/configuration/databases#trino) | `pip install trino` | `trino://{username}:{password}@{hostname}:{port}/{catalog}` |
| [Vertica](https://superset.apache.org/docs/configuration/databases#vertica) | `pip install sqlalchemy-vertica-python` | `vertica+vertica_python://<UserName>:<DBPassword>@<Database Host>/<Database Name>` |
| [YDB](https://superset.apache.org/docs/configuration/databases#ydb) | `pip install ydb-sqlalchemy` | `ydb://{host}:{port}/{database_name}` |
| [YugabyteDB](https://superset.apache.org/docs/configuration/databases#yugabytedb) | `pip install psycopg2` | `postgresql://<UserName>:<DBPassword>@<Database Host>/<Database Name>` |
...
### Installing Drivers in Docker Images [​](https://superset.apache.org/docs/configuration/databases/\#installing-drivers-in-docker-images "Direct link to Installing Drivers in Docker Images")
...
#### 1\. Determine the driver you need [​](https://superset.apache.org/docs/configuration/databases/\#1-determine-the-driver-you-need "Direct link to 1. Determine the driver you need")

Consult the [list of database drivers](https://superset.apache.org/docs/configuration/databases)
...
#### 2\. Install the driver in the container [​](https://superset.apache.org/docs/configuration/databases/\#2-install-the-driver-in-the-container "Direct link to 2. Install the driver in the container")
...
#### 3\. Connect to MySQL [​](https://superset.apache.org/docs/configuration/databases/\#3-connect-to-mysql "Direct link to 3. Connect to MySQL")
...
[Using Database Connection UI page](https://superset.apache.org/docs/configuration/databases#connecting-through-the-ui).
...
on the [MySQL page](https://superset.apache.org/docs/configuration/databases#mysql), we see that the connection string
...
#### 4\. Troubleshooting [​](https://superset.apache.org/docs/configuration/databases/\#4-troubleshooting "Direct link to 4. Troubleshooting")
...
### Database-specific Instructions [​](https://superset.apache.org/docs/configuration/databases/\#database-specific-instructions "Direct link to Database-specific Instructions")

#### Ascend.io [​](https://superset.apache.org/docs/configuration/databases/\#ascendio "Direct link to Ascend.io")
...
#### Apache Doris [​](https://superset.apache.org/docs/configuration/databases/\#apache-doris "Direct link to Apache Doris")
...
#### AWS Athena [​](https://superset.apache.org/docs/configuration/databases/\#aws-athena "Direct link to AWS Athena")

##### PyAthenaJDBC [​](https://superset.apache.org/docs/configuration/databases/\#pyathenajdbc "Direct link to PyAthenaJDBC")
...
##### PyAthena [​](https://superset.apache.org/docs/configuration/databases/\#pyathena "Direct link to PyAthena")
...
#### AWS DynamoDB [​](https://superset.apache.org/docs/configuration/databases/\#aws-dynamodb "Direct link to AWS DynamoDB")

##### PyDynamoDB [​](https://superset.apache.org/docs/configuration/databases/\#pydynamodb "Direct link to PyDynamoDB")
...
#### AWS Redshift [​](https://superset.apache.org/docs/configuration/databases/\#aws-redshift "Direct link to AWS Redshift")
...
This dialect requires either [redshift\_connector](https://pypi.org/project/redshift-connector/) or [psycopg2](https://pypi.org/project/psycopg2/) to work properly.
...
##### psycopg2 [​](https://superset.apache.org/docs/configuration/databases/\#psycopg2 "Direct link to psycopg2")
...
##### redshift\_connector [​](https://superset.apache.org/docs/configuration/databases/\#redshift_connector "Direct link to redshift_connector")
...
###### Using IAM-based credentials with Redshift cluster [​](https://superset.apache.org/docs/configuration/databases/\#using-iam-based-credentials-with-redshift-cluster "Direct link to Using IAM-based credentials with Redshift cluster")
...
###### Using IAM-based credentials with Redshift serverless [​](https://superset.apache.org/docs/configuration/databases/\#using-iam-based-credentials-with-redshift-serverless "Direct link to Using IAM-based credentials with Redshift serverless")
...
#### ClickHouse [​](https://superset.apache.org/docs/configuration/databases/\#clickhouse "Direct link to ClickHouse")
...
#### Cloudflare D1 [​](https://superset.apache.org/docs/configuration/databases/\#cloudflare-d1 "Direct link to Cloudflare D1")
...
#### CockroachDB [​](https://superset.apache.org/docs/configuration/databases/\#cockroachdb "Direct link to CockroachDB")
...
#### Couchbase [​](https://superset.apache.org/docs/configuration/databases/\#couchbase "Direct link to Couchbase")
...
#### CrateDB [​](https://superset.apache.org/docs/configuration/databases/\#cratedb "Direct link to CrateDB")

The connector library for CrateDB is [sqlalchemy-cratedb](https://pypi.org/project/sqlalchemy-cratedb/).
...
An SQLAlchemy connection string for [CrateDB Self-Managed](https://cratedb.com/product/self-managed) on localhost,
...
An SQLAlchemy connection string for connecting to [CrateDB Cloud](https://cratedb.com/product/cloud) looks like
this:
...
Follow the steps [here](https://superset.apache.org/docs/configuration/databases#installing-database-drivers)
...
#### Databend [​](https://superset.apache.org/docs/configuration/databases/\#databend "Direct link to Databend")
...
#### Databricks [​](https://superset.apache.org/docs/configuration/databases/\#databricks "Direct link to Databricks")
...
##### Older driver [​](https://superset.apache.org/docs/configuration/databases/\#older-driver "Direct link to Older driver")
...
#### Hive [​](https://superset.apache.org/docs/configuration/databases/\#hive "Direct link to Hive")
...
#### ODBC [​](https://superset.apache.org/docs/configuration/databases/\#odbc "Direct link to ODBC")
...
#### Denodo [​](https://superset.apache.org/docs/configuration/databases/\#denodo "Direct link to Denodo")
...
#### Dremio [​](https://superset.apache.org/docs/configuration/databases/\#dremio "Direct link to Dremio")

The recommended connector library for Dremio is
[sqlalchemy\_dremio](https://pypi.org/project/sqlalchemy-dremio/).
...
#### Apache Drill [​](https://superset.apache.org/docs/configuration/databases/\#apache-drill "Direct link to Apache Drill")

##### SQLAlchemy [​](https://superset.apache.org/docs/configuration/databases/\#sqlalchemy "Direct link to SQLAlchemy")
...
##### JDBC [​](https://superset.apache.org/docs/configuration/databases/\#jdbc "Direct link to JDBC")
...
##### ODBC [​](https://superset.apache.org/docs/configuration/databases/\#odbc-1 "Direct link to ODBC")
...
#### Apache Druid [​](https://superset.apache.org/docs/configuration/databases/\#apache-druid "Direct link to Apache Druid")
...
##### Customizing Druid Connection [​](https://superset.apache.org/docs/configuration/databases/\#customizing-druid-connection "Direct link to Customizing Druid Connection")
...
##### Aggregations [​](https://superset.apache.org/docs/configuration/databases/\#aggregations "Direct link to Aggregations")
...
##### Post-Aggregations [​](https://superset.apache.org/docs/configuration/databases/\#post-aggregations "Direct link to Post-Aggregations")
...
#### Elasticsearch [​](https://superset.apache.org/docs/configuration/databases/\#elasticsearch "Direct link to Elasticsearch")
...
Then register your table with the alias name logstash\_all
...
The DATETIME\_PARSE function is to support our `time_zone` setting, and here you need to fill in your elasticsearch version number in the Other > VERSION setting.
...
#### Exasol [​](https://superset.apache.org/docs/configuration/databases/\#exasol "Direct link to Exasol")
...
#### Firebird [​](https://superset.apache.org/docs/configuration/databases/\#firebird "Direct link to Firebird")
...
#### Firebolt [​](https://superset.apache.org/docs/configuration/databases/\#firebolt "Direct link to Firebolt")
...
#### Google BigQuery [​](https://superset.apache.org/docs/configuration/databases/\#google-bigquery "Direct link to Google BigQuery")
...
##### Install BigQuery Driver [​](https://superset.apache.org/docs/configuration/databases/\#install-bigquery-driver "Direct link to Install BigQuery Driver")

Follow the steps [here](https://superset.apache.org/docs/configuration/databases#installing-drivers-in-docker-images) about how to
...
##### Connecting to BigQuery [​](https://superset.apache.org/docs/configuration/databases/\#connecting-to-bigquery "Direct link to Connecting to BigQuery")
...
[pandas\_gbq](https://github.com/pydata/pandas-gbq) library.
...
#### Google Sheets [​](https://superset.apache.org/docs/configuration/databases/\#google-sheets "Direct link to Google Sheets")
...
#### Hana [​](https://superset.apache.org/docs/configuration/databases/\#hana "Direct link to Hana")
...
#### Apache Hive [​](https://superset.apache.org/docs/configuration/databases/\#apache-hive "Direct link to Apache Hive")
...
#### Hologres [​](https://superset.apache.org/docs/configuration/databases/\#hologres "Direct link to Hologres")
...
#### IBM DB2 [​](https://superset.apache.org/docs/configuration/databases/\#ibm-db2 "Direct link to IBM DB2")

The [IBM\_DB\_SA](https://github.com/ibmdb/python-ibmdbsa/tree/master/ibm_db_sa) library provides a
...
#### Apache Impala [​](https://superset.apache.org/docs/configuration/databases/\#apache-impala "Direct link to Apache Impala")
...
#### Kusto [​](https://superset.apache.org/docs/configuration/databases/\#kusto "Direct link to Kusto")
...
#### Apache Kylin [​](https://superset.apache.org/docs/configuration/databases/\#apache-kylin "Direct link to Apache Kylin")
...
#### MySQL [​](https://superset.apache.org/docs/configuration/databases/\#mysql "Direct link to MySQL")
...
#### IBM Netezza Performance Server [​](https://superset.apache.org/docs/configuration/databases/\#ibm-netezza-performance-server "Direct link to IBM Netezza Performance Server")
...
#### OceanBase [​](https://superset.apache.org/docs/configuration/databases/\#oceanbase "Direct link to OceanBase")
...
#### Ocient DB [​](https://superset.apache.org/docs/configuration/databases/\#ocient-db "Direct link to Ocient DB")

The recommended connector library for Ocient is [sqlalchemy-ocient](https://pypi.org/project/sqlalchemy-ocient).

##### Install the Ocient Driver [​](https://superset.apache.org/docs/configuration/databases/\#install-the-ocient-driver "Direct link to Install the Ocient Driver")

```bash
pip install sqlalchemy-ocient
```

##### Connecting to Ocient [​](https://superset.apache.org/docs/configuration/databases/\#connecting-to-ocient "Direct link to Connecting to Ocient")
...
#### Oracle [​](https://superset.apache.org/docs/configuration/databases/\#oracle "Direct link to Oracle")

The recommended connector library is
[cx\_Oracle](https://cx-oracle.readthedocs.io/en/latest/user_guide/installation.html).
...
#### Parseable [​](https://superset.apache.org/docs/configuration/databases/\#parseable "Direct link to Parseable")
...
Note: The stream\_name in the URI represents the Parseable logstream you want to query. You can use both HTTP (port 80) and HTTPS (port 443) connections.

##### Additional Resources

- [Blog: Parseable with Apache Superset](https://www.parseable.com/blog/parseable-with-apache-superset)

#### Apache Pinot [​](https://superset.apache.org/docs/configuration/databases/\#apache-pinot "Direct link to Apache Pinot")
...
#### Postgres [​](https://superset.apache.org/docs/configuration/databases/\#postgres "Direct link to Postgres")
...
#### QuestDB [​](https://superset.apache.org/docs/configuration/databases/\#questdb "Direct link to QuestDB")
...
#### Presto [​](https://superset.apache.org/docs/configuration/databases/\#presto "Direct link to Presto")
...
#### RisingWave [​](https://superset.apache.org/docs/configuration/databases/\#risingwave "Direct link to RisingWave")
...
#### Snowflake [​](https://superset.apache.org/docs/configuration/databases/\#snowflake "Direct link to Snowflake")

##### Install Snowflake Driver [​](https://superset.apache.org/docs/configuration/databases/\#install-snowflake-driver "Direct link to Install Snowflake Driver")

Follow the steps [here](https://superset.apache.org/docs/configuration/databases#installing-database-drivers) about how to
install new database drivers when setting up Superset locally via docker compose.
...
“validate\_default\_parameters”: True to the connect() method during engine creation. If the user/role
...
_**Please note that you need to merge multi-line private key content to one line and insert `\n` between each line**_
...
If your private key is stored on server, you can replace "privatekey\_body" with “privatekey\_path” in parameter.
...
#### Apache Solr [​](https://superset.apache.org/docs/configuration/databases/\#apache-solr "Direct link to Apache Solr")
...
#### Apache Spark SQL [​](https://superset.apache.org/docs/configuration/databases/\#apache-spark-sql "Direct link to Apache Spark SQL")
...
#### Arc [​](https://superset.apache.org/docs/configuration/databases/\#arc "Direct link to Arc")
...
#### SQL Server [​](https://superset.apache.org/docs/configuration/databases/\#sql-server "Direct link to SQL Server")
...
It is also possible to connect using [pyodbc](https://pypi.org/project/pyodbc) with the parameter [odbc\_connect](https://docs.sqlalchemy.org/en/14/dialects/mssql.html#pass-through-exact-pyodbc-string)
...
#### SingleStore [​](https://superset.apache.org/docs/configuration/databases/\#singlestore "Direct link to SingleStore")
...
#### StarRocks [​](https://superset.apache.org/docs/configuration/databases/\#starrocks "Direct link to StarRocks")
...
#### TDengine [​](https://superset.apache.org/docs/configuration/databases/\#tdengine "Direct link to TDengine")
...
#### Teradata [​](https://superset.apache.org/docs/configuration/databases/\#teradata "Direct link to Teradata")
...
#### ODBC Driver [​](https://superset.apache.org/docs/configuration/databases/\#odbc-driver "Direct link to ODBC Driver")
...
are available
here: [https://downloads.teradata.com/download/connectivity/odbc-driver/linux](https://downloads.teradata.com/download/connectivity/odbc-driver/linux)
...
#### TimescaleDB [​](https://superset.apache.org/docs/configuration/databases/\#timescaledb "Direct link to TimescaleDB")
...
#### Trino [​](https://superset.apache.org/docs/configuration/databases/\#trino "Direct link to Trino")

Supported trino version 352 and higher

##### Connection String [​](https://superset.apache.org/docs/configuration/databases/\#connection-string "Direct link to Connection String")
...
##### Authentications [​](https://superset.apache.org/docs/configuration/databases/\#authentications "Direct link to Authentications")

###### 1\. Basic Authentication [​](https://superset.apache.org/docs/configuration/databases/\#1-basic-authentication "Direct link to 1. Basic Authentication")
...
###### 2\. Kerberos Authentication [​](https://superset.apache.org/docs/configuration/databases/\#2-kerberos-authentication "Direct link to 2. Kerberos Authentication")
...
###### 3\. Certificate Authentication [​](https://superset.apache.org/docs/configuration/databases/\#3-certificate-authentication "Direct link to 3. Certificate Authentication")
...
###### 4\. JWT Authentication [​](https://superset.apache.org/docs/configuration/databases/\#4-jwt-authentication "Direct link to 4. JWT Authentication")
...
###### 5\. Custom Authentication [​](https://superset.apache.org/docs/configuration/databases/\#5-custom-authentication "Direct link to 5. Custom Authentication")
...
#### Vertica [​](https://superset.apache.org/docs/configuration/databases/\#vertica "Direct link to Vertica")
...
#### YDB [​](https://superset.apache.org/docs/configuration/databases/\#ydb "Direct link to YDB")

The recommended connector library for [YDB](https://ydb.tech/) is
[ydb-sqlalchemy](https://pypi.org/project/ydb-sqlalchemy/).

##### Connection String [​](https://superset.apache.org/docs/configuration/databases/\#connection-string-1 "Direct link to Connection String")
...
##### Protocol [​](https://superset.apache.org/docs/configuration/databases/\#protocol "Direct link to Protocol")
...
##### Authentication Methods [​](https://superset.apache.org/docs/configuration/databases/\#authentication-methods "Direct link to Authentication Methods")

###### Static Credentials [​](https://superset.apache.org/docs/configuration/databases/\#static-credentials "Direct link to Static Credentials")
...
###### Access Token Credentials [​](https://superset.apache.org/docs/configuration/databases/\#access-token-credentials "Direct link to Access Token Credentials")
...
##### Service Account Credentials [​](https://superset.apache.org/docs/configuration/databases/\#service-account-credentials "Direct link to Service Account Credentials")
...
#### YugabyteDB [​](https://superset.apache.org/docs/configuration/databases/\#yugabytedb "Direct link to YugabyteDB")
...
## Connecting through the UI [​](https://superset.apache.org/docs/configuration/databases/\#connecting-through-the-ui "Direct link to Connecting through the UI")
...
##### How to setup up preferred database options and images [​](https://superset.apache.org/docs/configuration/databases/\#how-to-setup-up-preferred-database-options-and-images "Direct link to How to setup up preferred database options and images")
...
##### Setting images [​](https://superset.apache.org/docs/configuration/databases/\#setting-images "Direct link to Setting images")
...
##### How to add new database engines to available endpoint [​](https://superset.apache.org/docs/configuration/databases/\#how-to-add-new-database-engines-to-available-endpoint "Direct link to How to add new database engines to available endpoint")
...
### Extra Database Settings [​](https://superset.apache.org/docs/configuration/databases/\#extra-database-settings "Direct link to Extra Database Settings")

##### Deeper SQLAlchemy Integration [​](https://superset.apache.org/docs/configuration/databases/\#deeper-sqlalchemy-integration "Direct link to Deeper SQLAlchemy Integration")
...
##### Schemas [​](https://superset.apache.org/docs/configuration/databases/\#schemas "Direct link to Schemas")
...
##### External Password Store for SQLAlchemy Connections [​](https://superset.apache.org/docs/configuration/databases/\#external-password-store-for-sqlalchemy-connections "Direct link to External Password Store for SQLAlchemy Connections")
...
##### SSL Access to Databases [​](https://superset.apache.org/docs/configuration/databases/\#ssl-access-to-databases "Direct link to SSL Access to Databases")
...
##### Custom Error Messages [​](https://superset.apache.org/docs/configuration/databases/\#custom-error-messages "Direct link to Custom Error Messages")
...
## Misc [​](https://superset.apache.org/docs/configuration/databases/\#misc "Direct link to Misc")

### Querying across databases [​](https://superset.apache.org/docs/configuration/databases/\#querying-across-databases "Direct link to Querying across databases")
...
#### Considerations [​](https://superset.apache.org/docs/configuration/databases/\#considerations "Direct link to Considerations")
...
#### Enabling the meta database [​](https://superset.apache.org/docs/configuration/databases/\#enabling-the-meta-database "Direct link to Enabling the meta database")
...
- [Installing Database Drivers](https://superset.apache.org/docs/configuration/databases/#installing-database-drivers)
  ...
  - [Installing Drivers in Docker Images](https://superset.apache.org/docs/configuration/databases/#installing-drivers-in-docker-images)
  - [Database-specific Instructions](https://superset.apache.org/docs/configuration/databases/#database-specific-instructions)
- [Connecting through the UI](https://superset.apache.org/docs/configuration/databases/#connecting-through-the-ui)
  - [Extra Database Settings](https://superset.apache.org/docs/configuration/databases/#extra-database-settings)
- [Misc](https://superset.apache.org/docs/configuration/databases/#misc)
  - [Querying across databases](https://superset.apache.org/docs/configuration/databases/#querying-across-databases)

![Project Logo](https://superset.apache.org/img/superset-logo-icon-only.png)
