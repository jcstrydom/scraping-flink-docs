# Flink DataStream API Programming Guide  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#flink-datastream-api-programming-guide)
...
with [anatomy of a Flink Program](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/#anatomy-of-a-flink-program) and gradually
add your own [stream transformations](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/operators/overview/). The remaining sections act as references for additional operations and advanced features.

## What is a DataStream?  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#what-is-a-datastream)
...
## Anatomy of a Flink Program  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#anatomy-of-a-flink-program)
...
[org.apache.flink.streaming.api](https://github.com/apache/flink/blob/release-2.2//flink-streaming-java/src/main/java/org/apache/flink/streaming/api)
.
...
from your program, and invoke it through the [command line](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/cli/), the Flink cluster manager will execute your main method and
...
## Example Program  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#example-program)
...
## Data Sources  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#data-sources)
...
`addSource(new FlinkKafkaConsumer<>(...))`. See [connectors](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/connectors/datastream/overview/) for more details.

## DataStream Transformations  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#datastream-transformations)

Please see [operators](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/operators/overview/) for an overview of the available stream transformations.

## Data Sinks  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#data-sinks)
...
## Execution Parameters  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#execution-parameters)
...
Please refer to [execution configuration](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/)
...
### Fault Tolerance  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#fault-tolerance)

[State & Checkpointing](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/fault-tolerance/checkpointing/) describes how to enable and configure Flink’s checkpointing mechanism.

### Controlling Latency  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#controlling-latency)
...
## Debugging  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#debugging)
...
### Local Execution Environment  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#local-execution-environment)
...
### Collection Data Sources  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#collection-data-sources)
...
### Iterator Data Sink  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#iterator-data-sink)
...
## Where to go next?  [\#](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/\#where-to-go-next)

- [Operators](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/operators/overview/): Specification of available streaming operators.
- [Event Time](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/concepts/time/): Introduction to Flink’s notion of time.
- [State & Fault Tolerance](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/fault-tolerance/state/): Explanation of how to develop stateful applications.
- [Connectors](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/connectors/datastream/overview/): Description of available input and output connectors.