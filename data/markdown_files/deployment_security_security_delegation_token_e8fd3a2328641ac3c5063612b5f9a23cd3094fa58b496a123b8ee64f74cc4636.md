> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/deployment/security/security-delegation-token/).

# Delegation Tokens  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#delegation-tokens)
...
![High Level Architecture Diagram](https://nightlies.apache.org/flink/flink-docs-release-1.20/fig/delegation_token_framework.svg)

## What Are Delegation Tokens and Why Use Them?  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#what-are-delegation-tokens-and-why-use-them)
...
### No need to distribute long-lived credentials  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#no-need-to-distribute-long-lived-credentials)
...
### A single token per service is used for authentication  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#a-single-token-per-service-is-used-for-authentication)
...
### Delegation tokens are only used for authentication  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#delegation-tokens-are-only-used-for-authentication)
...
## Lifecycle of Delegation Tokens  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#lifecycle-of-delegation-tokens)
...
## Delegation Token Renewal and Renewers  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#delegation-token-renewal-and-renewers)
...
### Who renews the tokens?  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#who-renews-the-tokens)
...
### Which tokens are renewed?  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#which-tokens-are-renewed)
...
libraries for creation _and_ renewal. This means that for YARN to be able to renew application
tokens, YARN needs:
...
### What happens when tokens expire for good?  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#what-happens-when-tokens-expire-for-good)
...
## Delegation Token Renewal  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#delegation-token-renewal)
...
## Delegation Tokens and Proxy Users  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#delegation-tokens-and-proxy-users)
...
## Externally Generated Delegation Tokens  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#externally-generated-delegation-tokens)
...
## Limitations of Delegation Token Support  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/security/security-delegation-token/\#limitations-of-delegation-token-support)
