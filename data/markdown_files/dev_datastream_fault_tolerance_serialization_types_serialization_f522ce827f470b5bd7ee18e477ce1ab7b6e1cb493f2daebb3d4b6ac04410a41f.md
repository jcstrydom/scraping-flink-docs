> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/datastream/fault-tolerance/serialization/types_serialization/).

# Data Types & Serialization  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#data-types--serialization)
...
## Supported Data Types  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#supported-data-types)
...
#### Tuples and Case Classes  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#tuples-and-case-classes)
...
#### POJOs  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#pojos)
...
#### Primitive Types  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#primitive-types)

Flink supports all Java and Scala primitive types such as `Integer`, `String`, and `Double`.

#### General Class Types  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#general-class-types)
...
#### Values  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#values)

_Value_ types describe their serialization and deserialization manually. Instead of going through a
...
#### Hadoop Writables  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#hadoop-writables)
...
#### Special Types  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#special-types)
...
Similarly to Scala’s `Either`, it represents a value of two possible types, _Left_ or _Right_.
`Either` can be useful for error handling or operators that need to output two different types of records.

#### Type Erasure & Type Inference  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#type-erasure--type-inference)
...
known as _type erasure_ in Java. It means that at runtime, an instance of an object does not know
...
[ResultTypeQueryable](https://github.com/apache/flink/blob/release-1.20//flink-core/src/main/java/org/apache/flink/api/java/typeutils/ResultTypeQueryable.java)

interface can be implemented by input formats and functions to tell the API
explicitly about their return type. The _input types_ that the functions are invoked with can
usually be inferred by the result types of the previous operations.

## Type handling in Flink  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#type-handling-in-flink)
...
## Most Frequent Issues  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#most-frequent-issues)
...
[pipeline.serialization-config](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/config/#pipeline-serialization-config):
...
Additional Kryo serializers are available in many libraries. See [3rd party serializer](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/third_party_serializers/) for more details on working with external serializers.

- **Adding Type Hints:** Sometimes, when Flink cannot infer the generic types despite all tricks, a user must pass a _type hint_. That is generally
only necessary in the Java API. The [Type Hints Section](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/#type-hints-in-the-java-api) describes that in more detail.

- **Manually creating a `TypeInformation`:** This may be necessary for some API calls where it is not possible for Flink to infer
the data types due to Java’s generic type erasure. See [Creating a TypeInformation or TypeSerializer](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/#creating-a-typeinformation-or-typeserializer)
for details.


## Flink’s TypeInformation class  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#flinks-typeinformation-class)

The class
[TypeInformation](https://github.com/apache/flink/blob/release-1.20//flink-core/src/main/java/org/apache/flink/api/common/typeinfo/TypeInformation.java)
...
( _Note that comparators in Flink do much more than defining an order - they are basically the utility to handle keys_)
...
#### Rules for POJO types  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#rules-for-pojo-types)
...
#### Creating a TypeInformation or TypeSerializer  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#creating-a-typeinformation-or-typeserializer)
...
In Scala, Flink uses _macros_ that runs at compile time and captures all generic type information while it is
still available.
...
[Rich Function](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/user_defined_functions/#rich-functions) and calling
...
## Type Information in the Scala API  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#type-information-in-the-scala-api)

Scala has very elaborate concepts for runtime type information though _type manifests_ and _class tags_. In
...
a _TypeInformation_ for the function’s return types (or parameter types) and make it part of the operation.

#### No Implicit Value for Evidence Parameter Error  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#no-implicit-value-for-evidence-parameter-error)

In the case where TypeInformation could not be created, programs fail to compile with an error
stating _“could not find implicit value for evidence parameter of type TypeInformation”_.
...
#### Generic Methods  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#generic-methods)
...
method. Scala offers _implicit parameters_ for that.\
\
The following code tells Scala to bring a type information for _T_ into the function. The type\
...
* * *\
\
## Type Information in the Java API  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#type-information-in-the-java-api)\
\
...
\
#### Type Hints in the Java API  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#type-hints-in-the-java-api)\
\
In cases where Flink cannot reconstruct the erased generic type information, the Java API\
offers so called _type hints_. The type hints tell the system the type of\
...
\
#### Type extraction for Java 8 lambdas  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#type-extraction-for-java-8-lambdas)\
\
...
\
#### Serialization of POJO types  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#serialization-of-pojo-types)\
\
...
using [pipeline.serialization-config](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/deployment/config/#pipeline-serialization-config):\
\
```yaml\
pipeline.serialization-config:\
...
```\
\
## Disabling Kryo Fallback  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#disabling-kryo-fallback)\
\
...
\
## Defining Type Information using a Factory  [\#](https://nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/fault-tolerance/serialization/types_serialization/\#defining-type-information-using-a-factory)\
\
