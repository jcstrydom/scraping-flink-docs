# Time Attributes  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#time-attributes)
...
For more information about time handling in Flink, see the introduction about [event time and watermarks](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/concepts/time/).

## Introduction to Time Attributes  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#introduction-to-time-attributes)
...
## Event Time  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#event-time)
...
### Defining in DDL  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#defining-in-ddl)

The event time attribute is defined using a `WATERMARK` statement in `CREATE` table DDL. A watermark statement defines a watermark generation expression on an existing event time field, which marks the event time field as the event time attribute. Please see [CREATE TABLE DDL](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/#create-table) for more information about watermark statement and watermark strategies.

Flink supports defining event time attribute on TIMESTAMP column and TIMESTAMP\_LTZ column.
...
#### Advanced watermark features  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#advanced-watermark-features)
...
##### I. Configure watermark emit strategy  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#i-configure-watermark-emit-strategy) [Anchor link for: i configure watermark emit strategy](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#i-configure-watermark-emit-strategy)
...
##### II. Configure the idle-timeout of source table  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#ii-configure-the-idle-timeout-of-source-table) [Anchor link for: ii configure the idle timeout of source table](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#ii-configure-the-idle-timeout-of-source-table)
...
##### III. watermark alignment  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#iii-watermark-alignment) [Anchor link for: iii watermark alignment](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#iii-watermark-alignment)
...
## Processing Time  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#processing-time)
...
### Defining in DDL  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#defining-in-ddl-1)

The processing time attribute is defined as a computed column in `CREATE` table DDL using the system `PROCTIME()` function, the function return type is TIMESTAMP\_LTZ. Please see [CREATE TABLE DDL](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/#create-table) for more information about computed column.
...
### During DataStream-to-Table Conversion  [\#](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/concepts/time_attributes/\#during-datastream-to-table-conversion-1)
